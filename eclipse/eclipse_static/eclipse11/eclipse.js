...
([function (e, t, a) {
			...
			function n(e, t) {
				...
				var o = a(5);
				i.scene = a(9),
				i.update = a(19).update,
				i.graphics = a(41);
				try {
					i.app = new o
				} catch (s) {
					console.exception("ranger/main: Failed to initialize Ranger: ", s),
					i.app && i.app.quit("ranger/main: Failed to initialize a library component", !0)
				}
				t && t()
			}
			a(2).set();
			var r = a(3);
			console.verbose = r.verbose,
			...
			function i(e, t) {
				for (var a in t) {
					...
					if ("undefined" != typeof n) {
						var o = t[a];
						"boolean" == typeof n ? t[a] = r(o) : "number" == typeof n ? t[a] = Number(o) : n.constructor === Array && (t[a] = Object.keys(o).map(function (e) {
										return o[e]
									})),
						"string" != typeof n && "boolean" != typeof n && "number" != typeof n && i(n, t[a])
					}
				}
			}
			function o(e, t) {
			...
			function r() {
				if ("INITALIZING" !== L)
					do
						x && N.app.renderEventProfiler(L), b[L]();
					while ("START_FRAME" !== L)
			}
			function i(e) {
			...
			function M(e, t, a, n, r) {
				var i = this.aux.newWindow(e, t, a, n, r);
				return i ? (I.push(i), i) : null
			}
			function g(e, t) {
				t.offsetLeft = "",
				t.offsetTop = "",
				...
				return t.resize = function () {
					...
					r = Math.abs(e.offsetHeight - e.clientHeight) / 2,
					t.left = Math.max(0, n + e.offsetLeft + a.offsetLeft),
					t.top = Math.max(0, N.canvas.offsetHeight - (r + e.offsetTop + a.offsetTop + a.offsetHeight)),
			...
			function p(e, t, a, n, r, i) {
				var o = e.subWindow(t, a, n, r);
				return o ? (I.push(o), N.scene.cameraData[o.camera.id] = {}, i || (i = N.canvas.parentElement), g(i, o)) : null
			}
			function m() {
			...
			b = {
				...
				RENDER_WINDOW: function () {
					A == I.length ? (L = "SWAP_BUFFERS", A = 0) : (f = I[A].camera, L = "JS_POST_TRANSFORM")
				},
				JS_POST_TRANSFORM: function () {
					var e = I[A].postTransformUpdate;
					"function" == typeof e && e(T, I[A], f),
					L = "POST_CAMERA_UPDATE"
				},
			...
			function a(e) {
				...
				r.style.width = a.offsetWidth + 2 + "px",
				r.style.height = a.offsetHeight + 2 + "px",
			...
			function n(e, t) {
				if (e.type && t.type) {
					...
					n = t.type;
					if (a in s && n in s)
						return a = s[a], n = s[n], 2 == a && a == n ? i.app.downloadManager.getPriority(t.params) - i.app.downloadManager.getPriority(e.params) : n - a
				}
			}
			function r() {
				return new o({
			...
			(function () {
				...
				({
					1: [function (e, t, a) {
							...
							r = e("./PriorityQueue/ArrayStrategy"),
							o = e("./PriorityQueue/BinaryHeapStrategy"),
							i = e("./PriorityQueue/BHeapStrategy"),
							s = function (e) {
								function t(e) {
									e || (e = {}),
					...
					3: [function (e, t, a) {
							...
							r = function (e, t, a) {
								...
								r,
								i;
								for (r = 0, n = e.length; r < n; )
									i = r + n >>> 1, a(e[i], t) >= 0 ? r = i + 1 : n = i;
								return r
							},
							t.exports = n = function () {
								function e(e) {
								...
								return e.prototype.queue = function (e) {
									var t;
									t = r(this.data, e, this.comparator),
							...
							t.exports = n = function () {
								function e(e) {
									...
									if (this._memory = [], this._mask = this.pageSize - 1, e.initialValues)
										for (s = e.initialValues, r = 0, i = s.length; r < i; r++)
											l = s[r], this.queue(l)
								}
								return e.prototype.queue = function (e) {
									this.length += 1,
								...
								e.prototype._bubbleUp = function (e, t) {
									...
									r,
									i;
									for (a = this.comparator; e > 1 && (n = e & this._mask, e < this.pageSize || n > 3 ? r = e & ~this._mask | n >> 1 : n < 2 ? (r = e - this.pageSize >> this._shift, r += r & ~(this._mask >> 1), r |= this.pageSize >> 1) : r = e - 2, i = this._read(r), !(a(i, t) < 0)); )
										this._write(r, t), this._write(e, i), e = r
								},
								e.prototype._bubbleDown = function (e, t) {
									...
									for (o = this.comparator; e < this.length; )
										if (e > this._mask && !(e & this._mask - 1) ? a = n = e + 2 : e & this.pageSize >> 1 ? (a = (e & ~this._mask) >> 1, a |= e & this._mask >> 1, a = a + 1 << this._shift, n = a + 1) : (a = e + (e & this._mask), n = a + 1), a !== n && n <= this.length)
											if (r = this._read(a), i = this._read(n), o(r, t) < 0 && o(r, i) <= 0)
												this._write(a, t), this._write(e, r), e = a;
											else {
												if (!(o(i, t) < 0))
													break;
												this._write(n, t),
							...
							t.exports = n = function () {
								...
								e.prototype._bubbleDown = function (e) {
									...
									for (t = this.data.length - 1; ; ) {
										if (a = (e << 1) + 1, r = a + 1, n = e, a <= t && this.comparator(this.data[a], this.data[n]) < 0 && (n = a), r <= t && this.comparator(this.data[r], this.data[n]) < 0 && (n = r), n === e)
											break;
										i = this.data[n],
			...
			function o(e, t) {
				for (var a in e) {
					...
					try {
						...
						console.exception('scene/Scene.load: Failed to load "' + a + '": ', i),
						t.reject()
					}
				}
			}
			...
			function l(e, t) {
				...
				if (a && a.rendered)
					for (var n in a.rendered) {
						var r = a.rendered[n],
						i = r.drawn;
						if (t(r.node, r.projectedPosition, i, r.visible))
							return
					}
			}
			function u(e, t) {
				...
				n = e.frame;
				for (var r in E)
					if (E[r].enabled && (!(e.name && E[r].cameras && e.name in E[r].cameras) || E[r].cameras[e.name])) {
						var i = D.math.inverse(n.orientation),
						o = D.math.qMulV(i, n.position),
						s = D.math.vAdd(o, E[r].transform.position);
						E[r].transform.parent = e.attachedNode;
						var c = D.math.getMatrix(D.frame.getTransform(E[r].transform));
						c[3][0] = s[0],
						c[3][1] = s[1],
						c[3][2] = s[2],
			...
			function d(e, t) {
				...
				if ("rotate" in t)
					if (4 === t.rotate.length)
						for (var r = D.math.qNormalized(t.rotate), i = 0; i < 4; i++)
							a[3][i] = r[i];
					else
			...
			function M(e, t, a, n) {
				var r = I[a.id];
				if (e.renderables) {
					var i = e.renderables.get(a);
					i && i.renderables.length && i.renderables.forEach(function (i) {
						if (i && (!(a.name && i.cameras && a.name in i.cameras) || i.cameras[a.name])) {
							var o = void 0,
							s = void 0;
							if ("enabled" in i.transform && i.transform.enabled) {
								var c = void 0;
								if ("relativeToParent" in i.transform && i.transform.relativeToParent) {
									var l = null;
									...
									c = d(e.frame.rootData[a.id].thisToRoot, i.transform);
								o = c.matrix,
								s = c.position
							} else
								o = D.math.getMatrix(e.frame.rootData[a.id].thisToRoot), s = D.math.getTranslation(e.frame.rootData[a.id].thisToRoot);
							if (s = D.math.qMulV(D.math.conjugate(a.frame.orientation), D.math.vSub(s, a.frame.position)), o = D.math.toM4(D.math.qMulM3(D.math.conjugate(a.frame.orientation), D.math.toM3(o)), s), !(e.name in r.rendered)) {
							...
							var m = r.rendered[e.name].position;
							"Label" === i.type && (i.data.projectedPosition = a.projectPosition(s), m = s),
							r.rendered[e.name].drawn.push({
								renderable: i,
								position: m
							}),
							n.push({
			...
			function p(e, t, a, n) {
				for (var r in t.relationship.children) {
					var i = t.relationship.children[r];
					i !== a && (M(i, t, e, n), p(e, i, null, n))
				}
			}
			function p(e, t, a, n) {
				for (var r in t.relationship.children) {
			...
			function m(e) {
				...
				r = [];
				for (t.rendered = {}; a; )
					a.loaded ? (M(a, a.relationship.parent, e, r), p(e, a, n, r), n = a, a = a.relationship.parent) : a = null;
				var i = {},
				o = function (a) {
					var n = t.rendered[a];
					return n.node.ellipsoid || n.drawn.length ? (i[a] = {
				...
				D.math.ellipsoidVisibilityCheck(i, e.frame.position, e.frame.orientation);
				for (var c in i)
					t.rendered[c].visible = i.visible, i[c].drawn.forEach(function (e) {
						e.real.visible = e.visible
					});
				return u(e, r),
				D.settings.usePainters && (r = this.paintersSort(r, e)),
			...
			T = {},
			y = [];
			f.scene.tags && (y = y.concat(f.scene.tags.split(",")));
			var L = [];
			f.scene.hooks && (L = L.concat(f.scene.hooks.split(","))),
			0 === L.length && (L = ["static", "fetch"]),
			...
			j = function (e, t) {
				...
				for (var i in e) {
					...
					s = [0, 0, 0],
					c = !1;
					if ("boundingEllipsoid" in e[i].renderable ? (o = !0, s = e[i].renderable.boundingEllipsoid) : "ellipsoid" in e[i].id.node && (o = !0, s = e[i].id.node.ellipsoid), o && "Light" !== e[i].renderable.type)
						if ("isOrbit" in e[i].renderable)
							c = e[i].renderable.isOrbit;
						else {
							var l = D.math.getTranslation(e[i].id.node.frame.rootData[t.id].thisToRoot);
							a.push({
								position: e[i].matrix[3].slice(0, 3),
								printPosition: l,
								ellipsoid: s,
								renderable: e[i],
								isOrbit: c
				...
				for (var v = [], T = 0; T < a.length; T++) {
					...
					for (var L = 0; L < y.length; L++)
						for (var w = T + 1; w < a.length; w++) {
							var I = y[L].near <= a[w].far && y[L].near >= a[w].near,
							E = y[L].far <= a[w].far && y[L].far >= a[w].near,
							j = a[w].near <= y[L].far && a[w].near >= y[L].near;
							(I || E || j) && g(y[L], a[w]) && (y.push(a[w]), a.splice(w, 1), w--)
						}
					v.push(y)
				}
				for (var x = 0; x < v.length; x++) {
					for (var b = v[x][0].near, C = v[x][0].far, S = 0; S < v[x].length; S++)
						v[x][S].near < b && (b = v[x][S].near), v[x][S].far > C && (C = v[x][S].far);
					r.push({
						near: b,
						far: C
					})
				...
				t.postCameraUpdate = function (e, a) {
					if (t.loaded) {
						...
						for (var n in t.relationship.children) {
							var r = t.relationship.children[n];
							r !== a && r.postCameraUpdate(e, t)
						}
					}
				},
				t.load = function (e) {
					...
					for (var a in e)
						try {
							...
							console.exception("Node.load: In node " + t.name + " failed to load component " + a, r)
						}
			...
			e.exports = function (e) {
				...
				return Object.defineProperty(t, "parent", {
					get: function () {
						return r[t.node.name]
					},
					set: function (e) {
						var a = t.node.name;
						if (r[a]) {
							var i = r[a];
							i.relationship.children[a] && delete i.relationship.children[a]
						}
						r[a] = e,
				...
				t.load = function (e) {
					...
					if ("children" in e && e.children.constructor === Array && e.children.forEach(function (e) {
						...
						var i = n.scene.get(e.parent);
						i.addTrigger(null, function () {
							t.parent = i
						}),
						i.triggerLoad()
					}
			...
			function n(e, t) {
				...
				a.removeRenderable = function (e) {
					...
					for (var i in a.ranges) {
						r = a.ranges[i];
						for (var o in r.renderables)
							e == r.renderables[o] && delete r.renderables[o]
					}
				...
				a.resolveRanges = function () {
					...
					for (var r = 0; r < e.length - 1; r++)
						e[r].end === 1 / 0 && (e[r].end = e[r + 1].start);
				...
				a.getRenderables = function (e, t) {
					...
					for (var r in a.ranges) {
						var i = a.ranges[r],
						o = e.getEnd(i.end, a.name);
						if (!(i.start > t || o <= t))
							for (var s in i.renderables) {
								var c = i.renderables[s];
				...
				a.getRenderable = function (e, t) {
					var n;
					return t in a.json ? (!(t in a.renderables) && t in a.json && (!a.json[t] || "null" === a.json[t].type || a.json[t].failed ? n = null : (n = new r.Renderable(r.app.core, e.node.context, a.json[t]), "boundingEllipsoid" in a.json[t] && (n.boundingEllipsoid = a.json[t].boundingEllipsoid), "isOrbit" in a.json[t] && (n.isOrbit = a.json[t].isOrbit), n || (console.error("scene/components/renderables.update: Failed to instantiate renderable", t, " in lod ", a, " in node ", e.node.name), a.json[t].failed = !0), "enabled" in a.json[t] && (n.enabled = a.json[t].enabled), "cameras" in a.json[t] && (n.cameras = JSON.parse(JSON.stringify(a.json[t].cameras)))), a.renderables[t] = n, e.updateTransforms()), n = a.renderables[t]) : n
				},
				a.updateRenderableTransform = function (e, t, n) {
					var r,
					i;
					n in a.json && (r = a.json[n], i = a.getRenderable(e, n), null !== r || void 0 !== r ? r.transform = t : console.error("LOD updateRenderableTransform: Json for Renderable is null or undefined: ", n), null !== i || void 0 !== i ? i.transform = t : console.error("LOD updateRenderableTransform: Renderable is null or undefined: ", n))
				},
				a.update = function (e, n, i) {
			...
			e.exports = function (e) {
				...
				t.addRenderable = function (e, a, n, r) {
					a = a ? a : "renderable",
					n = n ? n : "lod0",
					r = r ? r : {
						start:  - (1 / 0),
					...
					var s = i.addRenderable(e, a, o);
					return t.resolveRanges(),
					s
				},
				t.emplaceRenderable = function (e, a, n, r, i) {
					n = n ? n : "renderable",
					r = r ? r : "lod0",
					i = i ? i : {
						start:  - (1 / 0),
				...
				t.removeRenderable = function (e, a) {
					...
					i = null;
					if (a)
						return a in t.lod ? (n = t.lod[a], i = n.removeRenderable(e)) : (console.warn("RemoveRenderable: lodKey not Found in Renderables.lod. lodKey: ", a), null);
					for (var o in t.lod)
						n = t.lod[o], e in n.renderables && (r += 1, i || (i = n.removeRenderable(e)));
					return r > 1 && console.warn("RemoveRenderable: Found more than one Renderable object. Removing the first renderable found."),
					i
				},
				...
				t.updateRenderableTransform = function (e, a, n) {
					...
					if (n) {
						...
						r = t.lod[n],
						a in r.json && (n in t.transform || (t.transform[n] = {}), t.transform[n][a] = e)
					} else
						for (var i in t.lod)
							r = t.lod[i], a in r.json && (i in t.transform || (t.transform[i] = {}), t.transform[i][a] = e);
					t.updateTransforms()
				},
				t.getRenderable = function (e, a) {
					...
					i = 0;
					if (a)
						return a in t.lod ? (r = t.lod[a], n = r.getRenderable(t, e)) : (console.warn("GetRenderable: lodKey not Found in Renderables.lod. lodKey: ", a), null);
					for (var o in t.lod)
						r = t.lod[o], e in r.renderables && (i += 1, void 0 === n && (n = r.getRenderable(t, e)));
					return i > 1 && console.warn("GetRenderable: Found more than one Renderable object. Returning the first renderable found."),
					n
				},
				t.lodEnabled = function (e, a) {
					return e in t.lod && (t.lod[e].enabled = a, !0)
				},
				t.addLOD = function (e, a, r) {
					...
					if (t.lod[a].ranges.push(i), e.renderables) {
						if ("type" in e.renderables)
							return void t.addRenderable(e.renderables, r ? r : a, a, i);
						for (var o in e.renderables)
							t.addRenderable(e.renderables[o], o, a, i)
					}
				},
				t.load = function (e) {
					if ("renderables" in e)
				...
				t.getEnd = function (e, a) {
					...
					r = !1,
					i = 1;
					if (t.transform.enabled && "scale" in t.transform && (r = !0, i = 3 === t.transform.scale.length ? Math.max(t.transform.scale[0], t.transform.scale[1], t.transform.scale[2]) : t.transform.scale), a in t.transform)
				...
				t.getTransform = function (e) {
					...
					if ("rotate" in e && 4 === e.rotate.length)
						for (var l = 0; l < 4; l++)
							n[l] = e.rotate[l];
					return "relativeToParent" in e && (r = e.relativeToParent), {
						scale: t,
						translate: a,
						rotate: n,
						enabled: i,
					...
					for (var a in t.lod)
						if (a in t.transform)
							for (var n in t.lod[a].renderables) {
								var r = "ignoreNodeTransform" in t.lod[a].renderables[n].transform;
								if (!r || !t.lod[a].renderables[n].transform.ignoreNodeTransform)
									if (n in t.transform[a]) {
										var i = t.getTransform(t.transform[a][n]);
										"override" in t.transform[a][n] && t.transform[a][n].override ? t.lod[a].renderables[n].transform = i : t.lod[a].renderables[n].transform = t.combineTransforms(e, i)
									} else
				...
				t.combineTransforms = function (e, t) {
					...
					i = r.math.qMulQ(e.rotate, t.rotate);
					return {
						scale: a,
						translate: n,
						rotate: i,
				...
				t.get = function (e) {
					if (t.node.loaded && t.node.frame.rootData[e.id]) {
						...
						for (var r in t.lod) {
							var i = t.lod[r];
							i.enabled && (a.renderables = a.renderables.concat(i.getRenderables(t, n)))
						}
						return a
					}
				},
			...
			e.exports = function (e) {
				...
				t.load = function (e) {
					"parent" in e && "string" == typeof e.parent && (t.forceParent = r.scene.get(e.parent));
					var a = [0, 0, 0];
					"position" in e && (a = e.position);
					var i = [0, 0, 0, 1];
					"orientation" in e && (i = e.orientation),
					t.node.context || (t.node.context = new n.context(t.node)),
					t.node.context.emplace("position", "frame", a),
					t.node.context.emplace("orientation", "frame", i),
					t.invalidate()
				},
				...
				t.update = function (e) {
					...
					var n = r.frame.getTransformInverse(a),
					i = r.frame.getTransform(a);
					...
					t.node.context.emplace("affine3", "thisToParent", i),
					t.updateCallbacks.trigger(t.node),
					t.lastUpdate = e.time.value,
					!0
				},
				t.findLCA = function (e) {
					for (var a = [], n = [], r = t.node; r && r.loaded; r = r.frame.parent) {
						if (r.frame.LCA[e.name])
							return t.LCA[e.name] = r.frame.LCA[e.name], t.LCA[e.name];
						n.push(r)
					}
					for (r = e; r && r.loaded; r = r.frame.parent)
						a.push(r);
					if (a.length !== n.length)
						for (var i = a.length > n.length ? a : n, o = Math.abs(a.length - n.length); o--; )
							i.shift();
				...
				t.getDistance = function (e) {
					if (t.node.loaded && t.rootData[e.id]) {
						var a = r.math.getTranslation(t.rootData[e.id].thisToRoot);
						return a = r.math.qMulV(r.math.conjugate(e.frame.orientation), r.math.vSub(a, e.frame.position)),
						r.math.vNorm(a)
					}
				},
				t.updateRootData = function (e, a) {
					...
					if (!t.LCA[n].frame.rootData[a.id]) {
						...
						c.frame.rootData[a.id] || (s = {
								...
								time: e.time
							}, i = r.frame.getTransform(s), o = r.frame.getTransformInverse(s), c.context.replace("affine3", "rootToThis" + a.id, i), c.context.replace("affine3", "thisToRoot" + a.id, o), c.frame.rootData[a.id] = {
								frame: s,
								rootToThis: i,
								thisToRoot: o
							});
						for (var l = c, u = c.frame.rootData[a.id]; c !== t.LCA[n]; ) {
							...
							if (c.frame.lastUpdate !== e.time && !c.frame.update({
								...
								return !1;
							c.frame.rootData[a.id] || (i = r.math.aMulA(l.context.get("affine3", "thisToParent"), d.rootToThis), o = r.math.aMulA(d.thisToRoot, l.context.get("affine3", "parentToThis")), c.context.replace("affine3", "rootToThis" + a.id, i), c.context.replace("affine3", "thisToRoot" + a.id, o), s = {
									parent: e.parent,
									position: r.math.getTranslation(o),
									orientation: r.math.qMulQ(c.frame.last.orientation, d.frame.orientation),
									time: e.time
					...
					return i = r.math.aMulA(t.node.context.get("affine3", "parentToThis"), M.rootToThis),
					o = r.math.aMulA(M.thisToRoot, t.node.context.get("affine3", "thisToParent")),
					t.node.context.replace("affine3", "rootToThis" + a.id, i),
					t.node.context.replace("affine3", "thisToRoot" + a.id, o),
					s = {
						parent: e.parent,
						position: r.math.getTranslation(o),
						orientation: r.math.qMulQ(t.last.orientation, M.frame.orientation),
						time: e.time
					},
					t.rootData[a.id] = {
						frame: s,
				...
				t.convert = function (e, a) {
					var n,
					i = a;
					if ("undefined" != typeof i && "id" in i && (n = i, i = t.lastUpdate), "undefined" == typeof i ? i = "undefined" == typeof e.time ? t.lastUpdate : e.time : "number" != typeof i && "value" in i && (i = i.value), isNaN(i) && (i = e.time), !n)
						for (var o in t.rootData)
							t.rootData[o].frame.time === i && (n = {
									id: o
								});
					"time" in e && i !== e.time && console.warn("scene/components/frame.convert: Asked to convert frames across time");
					var s = {
						parent: e.parent,
					...
					if (n)
						...
						for (c = r.frame.getTransform({
							...
							if (!M || !M.loaded || !M.context.contains("affine3", "parentToThis"))
								return s;
							c = r.math.aMulA(c, M.context.get("affine3", "parentToThis"))
						}
						for (l = r.frame.getTransform({
									parent: null,
									position: [0, 0, 0],
									orientation: [0, 0, 0, 1]
							...
							if (!M || !M.loaded || !M.context.contains("affine3", "thisToParent"))
								return s;
							l = r.math.aMulA(M.context.get("affine3", "thisToParent"), l)
						}
					}
					return c && l ? (s.parent = t.node, s.position = r.math.aMulV(c, r.math.aMulV(l, e.position)), s.orientation = r.math.qMulQ(r.math.getRotation(c), r.math.qMulQ(r.math.getRotation(l), e.orientation)), s) : s
				},
				t.load({}),
				t
			}
			...
			e.exports = function () {
				...
				e.remove = function (t) {
					var a,
					n = -1;
					for (var r in e.callbacks)
						if (t in e.callbacks[r]) {
							n = r,
							a = e.callbacks[r];
							break
						}
			...
			function n(e, t) {
				...
				if (a) {
					if (t || (t = {}), "function" == typeof a)
						...
						for (var r in a.parameters)
							r in t || (t[r] = a.parameters[r]);
						for (r in t)
							r[0] === r[0].toUpperCase() && console.error("scene/template: Upper case parameter names are not allowed:", r, "in", e);
						a = a.value
					}
					return JSON.parse(JSON.stringify(a), function (e, a) {
						...
						if ("string" == typeof a && "$" === a[0]) {
							var i = a.slice(1);
							return i[0] === i[0].toUpperCase() ? "0" === e ? a : (r = n(i), "undefined" != typeof r ? r : a) : i in t ? JSON.parse(JSON.stringify(t[i])) : (console.warn("scene/template: Missing parameter", "$" + i), a)
						}
						return Array.isArray(a) && a.length >= 1 && "string" == typeof a[0] && "$" === a[0][0] ? (a.length > 2 && console.warn("scene/template: Template template array has extra elements:", a), r = n(a[0].slice(1), a[1]), "undefined" != typeof r ? r : a) : a
					})
				}
			}
			function r(e) {
			...
			e.exports = function () {
				...
				e.removeRestriction = function (t, a) {
					var n,
					r = -1;
					for (var i in e.states[t].restrict)
						if (a === e.states[t].restrict[i]) {
							r = i,
							n = e.states[t].restrict[i];
							break
						}
					return r > -1 && e.states[t].restrict.splice(r, 1),
					n
				},
			...
			function o(e, t, a) {
				if (E.indexOf(e) < 0) {
					for (var n = document.getElementsByClassName("rangerLabel"), r = 0; r < n.length; r++)
						n[r].addEventListener(e, function (e) {
							e.preventDefault(),
							e.type in I && I[e.type].trigger(e.target.node, e)
						});
					E.push(e)
				}
				void 0 !== t && void 0 !== a && i(e, t, a)
			}
			function s(e) {
				e in I && delete I[e]
			}
			...
			function u(e, t, a, n) {
				...
				r.name = a.data.Text,
				"System" === t.nodeType ? r.style.color = "rgb(255, 127, 51)" : "Star" === t.nodeType ? r.style.color = "rgb(255, 127, 51)" : "Planet" === t.nodeType && (r.style.color = "White"),
				a.data.color && (r.style.color = a.data.color),
				l(r, t, e),
				r.className = "nodeLabel rangerLabel";
				var i = document.createAttribute("eye");
				return i.value = n,
				r.setAttributeNode(i),
				t.interactable === !1 && (r.className += " non-interactable"),
				r
			}
			function d(e, t, a, n) {
				var r = document.createElement("div");
				r.className = "surfaceDot",
				r.node = t,
				r.labelType = a.data.labelType,
				r.id = "surfaceLabelContainer-" + a.data.id,
				r.name = a.data.name,
				r.innerHTML = "&bull;";
				var i = document.createElement("div");
				i.className = "surfaceLabel rangerLabel",
				i.node = t,
				i.labelType = a.data.labelType,
				i.name = a.data.name,
				i.id = a.data.id;
				var o = a.data.Text;
				"" === o ? r.style.display = "none" : r.style.display = "",
				i.innerHTML = a.data.Text,
				i.displayText = o,
				a.data.color && (r.style.color = a.data.color, i.style.color = a.data.color),
				l(i, t, e);
			...
			function M(e, t, a, n) {
				var r = document.createElement("div");
				r.className = "markerLabel",
				r.node = t,
				r.labelType = a.data.labelType,
				r.name = a.data.name,
				r.locationId = a.data.locationId,
				r.id = "markerContainer-" + a.data.id;
				var i = document.createElement("a");
				i.className = "marker rangerLabel ranger-svg",
				i.id = a.data.id,
				i.node = t,
				i.labelType = a.data.labelType,
				i.name = a.data.name,
				...
				a.data.color && (r.color = a.data.color, o.color = a.data.color),
				l(i, t, e);
				var s = document.createAttribute("eye");
				return s.value = n,
				r.setAttributeNode(s),
			...
			function g(e, t, a, n, r, i) {
				...
				case "Node":
					...
					void 0 === t.labelDiv[i] && (t.labelDiv[i] = u(e, t, n, i)),
					o = t.labelDiv[i],
					o.innerHTML = n.data.Text,
					o.labelType in j && !j[o.labelType] && (o.style["pointer-events"] = "none");
					break;
				case "Marker":
					void 0 === t.markerDivs[n.data.id] && (t.markerDivs[n.data.id] = M(e, t, n, i)),
					...
					break;
				case "Surface":
					void 0 === t.surfaceDivs[n.data.id] && (t.surfaceDivs[n.data.id] = d(e, t, n, i)),
			...
			function p(e, t, a) {
				for (var n, r, i = 0; i < e.length; i++)
					if (e[i].style.opacity > .4)
						for (var o = i + 1; o < e.length; o++)
							e[o].style.opacity > .4 && (n = e[i].getBoundingClientRect(), r = e[o].getBoundingClientRect(), n.top > r.bottom || n.right < r.left || n.bottom < r.top || n.left > r.right || (e[i].name === a ? e[o].style.opacity = .4 : e[o].name === a ? e[i].style.opacity = .4 : t[e[i].name] < t[e[o].name] ? e[o].style.opacity = .4 : e[i].style.opacity = .4))
			}
			function m(e, t) {
				for (var a, n, r = 0; r < e.length; r++)
					if (e[r].style.opacity > .5)
						for (var i = r + 1; i < e.length; i++)
							e[i].style.opacity > .5 && (a = e[r].getBoundingClientRect(), n = e[i].getBoundingClientRect(), a.top > n.bottom || a.right < n.left || a.bottom < n.top || a.left > n.right || (t[e[r].name] < t[e[i].name] ? e[i].style.opacity = .5 : e[r].style.opacity = .5))
			}
			function A(e) {
				x = e
			}
			...
			function D(e, t) {
				var a = e,
				n = [],
				r = document.getElementById("labels"),
				s = function () {
					var e,
					i,
					o = [],
					...
					l = {},
					u = [];
					t && N.scene.walk(t, function (t, r, d) {
						for (var M = 0; M < r.length; M++) {
							var p;
							if (r[M][2] > 0 && r[M][0] > -1.2 && r[M][0] < 1.2 && r[M][1] > -1.2 && r[M][1] < 1.2) {
								for (var m in d) {
									var A = r[M],
									f = d[m];
									f.visible && null !== f.renderable && "Label" === f.renderable.type && ("projectedPosition" in f.renderable.data && (A = f.renderable.data.projectedPosition[M]), "System" === t.nodeType && (e = f.renderable.data.Text), i = g(a, t, A, f.renderable, c, M), void 0 !== i && (l[i.name] = A[2], o.push(i), i.parentNode || s.push(i), c += 1, p = [t, i]))
								}
					...
					for (var y = 0; y < n.length; y++)
						for (var I = n[y], E = I.children.length - 1; E >= 0; E--)
							o.indexOf(I.children[E]) < 0 && ("onremove" in I.children[E] && I.children[E].onremove(), I.removeChild(I.children[E]));
					if (h.vr) {
						var j,
						x,
						b = null;
						if (0 !== u.length && (j = L.getIntersection(u, l)))
							w.resetRay(), (b = L.getCurrPair()) && b[0] != j[0] && L.VRmouseout(b, b[0].labelDiv[1]), L.VRmouseover(j, j[0].labelDiv[1]), L.incClock(), L.getClock() > 70 && (L.VRmouseout(j, j[0].labelDiv[1]), L.VRmouseclick(j));
						else {
							var C = L.getCurrPair();
							C && L.VRmouseout(C, C[0].labelDiv[1]),
							L.resetRay(),
				...
				o("click", "transitionToNode", function (e) {
					T.actions.onClick(e, y.speed.standard)
				}),
				...
				i("onremove", "resetClock", function (e) {
			...
			function n(e) {
				r = e,
				r.addBackgroundHandler(o.TouchHandler("backgroundTouch", {
						singleTap: function (e, t, a, n, r, i, o, c, l, u) {
							s.backgroundSingleTap(e, t, a, n, r, i, o, c, l, u)
						},
						doubleTap: function (e, t, a, n, r, i, o, c, l, u) {
							s.backgroundDoubleTap(e, t, a, n, r, i, o, c, l, u)
						}
					})),
				r.addBackgroundHandler(o.MouseHandler("backgroundMouse", {
						click: function (e, t, a, n, r, i) {
							s.backgroundClick(e, t, a, n, r, i)
						},
						doubleClick: function (e, t, a, n, r, i) {
							s.backgroundClick(e, t, a, n, r, i)
						}
					}))
			}
			...
			s.onClick = function (e, t) {
				...
				n = {
					frame: r.cameraState.frame,
					target: e,
					parent: e,
					radius: a / (.25 * Math.tan(r._camera.fov)),
					positionTime: t,
					win: r,
				...
				return r.setCamera(i.trackingTransition(n)),
				!0
			},
			s.onMouseOver = function (e) {
				c = r._window.camera.clock.rate,
				e.mouseOver = !0,
				r._window.camera.clock = {
					time: r._window.camera.clock.time,
					rate: 0
				}
			},
			...
			s.onLabelRemove = function (e) {
				e.mouseOver && (r._window.camera.clock = {
						time: r._window.camera.clock.time,
						rate: c
					})
			},
			s.onPick = function (e, t, a) {
				...
				e && e.node && s.onClick(e.node, i.speed.standard, !1)
			},
			s.backgroundSingleTap = function (e, t, a, n, r, i, o, s, c, l) {
				console.verboseLog("Single tap " + o + " : " + s + ". Picked fragment info: " + l)
			},
			s.backgroundDoubleTap = function (e, t, a, n, r, i, o, c, l, u) {
				console.verboseLog("Double tap " + o + " : " + c + ". Picked fragment info: " + u),
				s.onPick(u, o, c)
			},
			s.backgroundClick = function (e, t, a, n, r, i) {
				console.verboseLog("Single Click " + n + " : " + r + ". Picked fragment info " + i),
				s.onPick(i, n, r)
			},
			s.backgroundDoubleClick = function (e, t, a, n, r, i) {
				console.verboseLog("Double clicked " + t + " at " + n + "," + r + ". Picked fragment info " + i)
			},
			e.exports = {
				init: n,
				actions: s
			...
			e.exports = {
				...
				trackingTransition: function (e) {
					...
					var a = function (e) {
						var t = {};
						return t.forward = n.math.qMulV(e, r.vector.FORWARD),
						t.up = n.math.qMulV(e, r.vector.UP),
						t
					};
					...
					t.update = function (e, a) {
						t.time += a;
						var r = n.math.vNorm(n.math.vSub(t.frame.position, t.position.end));
						if (t.time > t.positionTime || r < .1) {
							if (t.win) {
								var i = 1;
								t.target.camera && (i = t.target.camera.preferred[0].radius);
								var o = {
									target: t.target,
									frame: t.frame,
									radius: t.radius || i,
					...
					t.enter = function (e) {
						...
						t.lookUp.start = n.math.qMulV(e.cameraState.frame.orientation, r.vector.UP),
						...
						var i = r.vector.FORWARD;
						i = n.math.qMulV(t.orientation.start, i),
						i = n.math.vMul(i, a);
						var o = n.math.lookRotation(i, t.lookUp.start);
						if (t.orientation.start = o, t.lookPointStart = n.math.vAdd(i, t.frame.position), !t.bezierTangents) {
							var s,
							c = a,
			...
			e.exports = function (e) {
				...
				t.getMinAltitude = function (e, t) {
					...
					n = !1,
					r = {},
					i = t.parent.context.getAllRecursive("GeometryFinder", e._camera.clock.time);
					for (var o in i)
						for (var s in i[o]) {
							var c = i[o][s].getSurfaceHeight(e._camera, t);
							if (c.found) {
								...
								M = d / c.normal[u];
								(!n || M < n) && (n = M, a = c, r.pos = l, r.result = c, r.diff = d)
							}
						}
					return !!n && {
				...
				t.scaleSpeed = function (e, a, n, r) {
					if (e < a)
						return e / a * n;
					var i = Math.pow(1 + e - a, t.altitudePower) * n;
					return r ? Math.min(r, i) : i
				},
				t.altitudeOffset = t.altitudeOffset || 10,
				t.linearSpeedAltitude = t.linearSpeedAltitude || 20,
				t.maxLinearSpeed = t.maxLinearSpeed || 1,
				t.getVelocity = function (e, a, n, r) {
					var i = n,
					o = n > 0 ? 1 : -1,
					...
					return t.radius && Math.abs(i) > t.radius && (i = o * t.radius / 2),
					Math.abs(i) > r && (i = o * r),
					i
				},
				t.checkFrame = function (e, a, n) {
					var r = !1,
					i = t.getMinAltitude(e, a);
					return i && i.altitude < n && (r = i, r.magnitude =  - (i.altitude - n)),
					r
				},
				t.getClosestSurface = function (e) {
					...
					var r = n.scene.cameraData[e.id].attachedNode,
					i = {
						parent: r,
						position: [0, 0, 0],
						orientation: [0, 0, 0, 1]
					},
					o = r.context.getAllRecursive("GeometryFinder", e.clock.time);
					for (var s in o)
						for (var c in o[s])
							if (o[s][c].ptr) {
								var l = o[s][c].getSurfaceHeight(e, i);
								if (l.found) {
									var u = l.frame.parent.frame.convert(i, e.clock.time).position,
									d = "x";
			...
			e.exports = function (e) {
				...
				a.update = function (t, i) {
					if (a.frame.parent = a.target, !e.locked) {
						...
						a.freeLook.update(t, i, p[2], p[0], p[1]),
						a.zoomController.update(i)
					}
					a.frame.orientation = a.freeLook.orientation,
					a.radius = a.zoomController.zoomLevel * a.nominalRadius,
					a.frame.position = n.math.vAdd(n.math.vMul(n.math.vNormalized(n.math.qMulV(a.frame.orientation, r.vector.FORWARD)), -a.radius), a.offset)
				},
				a.frame || (a.frame = {
						parent: a.target,
						position: [0, 0, 0],
			...
			e.exports = function (e) {
				...
				t.updateFrameParent = function (e, a, r) {
					if (a = n.scene.get(a), r = n.scene.get(r), r && r != a) {
						var i = n.Frame();
						i.parent = a,
						i.position = [0, 0, 0],
						i.orientation = t.orientation,
						t.orientation = r.frame.convert(i, e.clock.time).orientation,
						i.orientation = t.targetOrientation,
						t.targetOrientation = r.frame.convert(i, e.clock.time).orientation
					}
				},
				t.update = function (e, a, r, i, o) {
					a = Math.min(a, 1);
					...
					t.targetOrientation = n.math.qNormalized(n.math.qMulQ(n.math.angleAxis(u, i), t.targetOrientation)),
					t.targetOrientation = n.math.qNormalized(n.math.qMulQ(n.math.angleAxis(d, r), t.targetOrientation)),
					t.updateSmoothing(a),
					t.resetKeys()
				},
				t.updateSmoothing = function (a) {
					...
					if (e.locked) {
						...
						r = 180 * Math.acos(n.math.vDot(M, g)) / Math.PI,
						r > e.locked.degree && r > o ? t.lookSpeed = Math.min(2e-4 / r, .001) : t.lookSpeed = i,
						o = r
					}
				...
				t.enter = function (a) {
					...
					t.mouse = r.MouseHandler("camera_look_mouse", {
							drag: function (a, n, r) {
					...
					t.touch = r.TouchHandler("camera_look_touch", {
							touch: function () {},
							touchDrag: function (a, n, r, i, o, s) {
								return t.buttonDown = !0,
								t.dragX = o,
								t.dragY = s,
								e.locked && e.locked.moveLimit && (t.dragX = Math.abs(t.dragX) > e.locked.moveLimit ? 0 : t.dragX, t.dragY = Math.abs(t.dragY) > e.locked.moveLimit ? 0 : t.dragY),
					...
					t.bindings = r.KeyBinder("camera_look_bindings", {
							SHIFT: n,
							A: i,
							LEFT: i,
							D: o,
			...
			function r(e) {
				...
				if (e.changedTouches.length > 0)
					for (r = 0; r < e.changedTouches.length; r++)
						t = n(e.changedTouches[r].identifier, a), t >= 0 ? a.splice(t, 1, {
							identifier: e.changedTouches[r].identifier,
							x: e.changedTouches[r].clientX,
							y: e.changedTouches[r].clientY
						}) : a.push({
							identifier: e.changedTouches[r].identifier,
							x: e.changedTouches[r].clientX,
							y: e.changedTouches[r].clientY
			...
			function s(e, t) {
				var a = i(e);
				return a.move = function (e, t, a, n, r) {
					return !1
				},
				a.drag = function (e, t, a, n, r) {
					return !1
				},
				a.click = function (e, t, a, n, r) {
					return !1
				},
				a.doubleClick = function (e, t, a, n, r) {
					return !1
				},
			...
			function c(e, t) {
				var a = i(e);
				return a.touch = function (e, t, a, n, r, i, o, s, c) {
					return !1
				},
				a.touchDrag = function (e, t, a, n, r, i, o, s, c) {
					return !1
				},
				a.singleTap = function (e, t, a, n, r, i, o, s, c) {
					return !1
				},
				a.doubleTap = function (e, t, a, n, r, i, o, s, c) {
					return !1
				},
				a.multi = function (e, t, a, n, r, i, o) {
					return !1
				},
				a.gesture = function (e, t, a, n, r, i, o) {
					return !1
				},
			...
			A.mouseMove = function (e) {
				...
				r = e.pageY - t || e.clientY || 0;
				u.cursorPosition = [n, r],
				f.pressed && (f.dragging = !0, m.queue({
						type: "CURSOR_MOVED",
						params: {
							drag: !0,
							relativeX: n - f.previousX,
							relativeY: r - f.previousY,
							absoluteX: n,
							absoluteY: r
						}
					})),
			...
			A.mouseUp = function (e) {
				if (e.preventDefault(), f.pressed && !f.dragging && 0 === f.clickCount) {
					...
					f.clickedX = n,
					f.clickedY = r;
					for (var i in u._window.pickedFragmentInfo)
						f.pickedFragmentInfo[i] = u._window.pickedFragmentInfo[i];
			...
			A.touchStart = function (e) {
				e.preventDefault();
				for (var t, a = r(e), i = 0; i < a.length; i++)
					t = n(a[i].identifier, h.ongoingTouches), t >= 0 ? h.ongoingTouches.splice(t, 1, {
			...
			A.touchMove = function (e) {
				...
				if (h.startDragTouches || (h.startDragTouches = o), 1 === o.length && 1 === h.ongoingTouches.length) {
					...
					h.startDragTouches && (t = Math.pow(h.startDragTouches[0].x - o[0].x, 2), a = Math.pow(h.startDragTouches[0].y - o[0].y, 2), i = Math.sqrt(t + a), i >= h.minDeltaDistance && (h.dragging = !0, m.queue({
								type: "TOUCH_DRAG",
								params: {
									type: "drag",
									device: "tablet",
					...
					if (t = Math.pow(o[0].x - o[1].x, 2), a = Math.pow(o[0].y - o[1].y, 2), i = Math.sqrt(t + a), h.previousDistanceBetweenFingers) {
						h.dragging = !0;
						var s = i - h.previousDistanceBetweenFingers;
						m.queue({
							type: "MULTITOUCH",
							params: {
								device: "tablet",
					...
					h.previousDistanceBetweenFingers = i,
			...
			A.touchEnd = function (e) {
				...
				if (1 !== a.length || h.dragging || 0 !== h.tapCount)
					...
					h.tapY = a[0].y;
					for (var i in u._window.pickedFragmentInfo)
						h.pickedFragmentInfo[i] = u._window.pickedFragmentInfo[i];
			...
			function a(e) {
				var t = e.keyCode;
				return t >= 65 && t <= 90 ? t += 32 : (t = i[e.keyCode] || e.keyCode, 2 === e.location && t >= 1248 && t <= 1251 && (t += 4)),
				t
			}
			function n(e) {
				var t,
			...
			e.exports = function (e) {
				...
				t.update = function (e) {
					...
					n = t.speedMod ? .01 : 1,
					r = -a * n * .75;
					t.forwardPressed && (r -= 2 * e),
					t.backPressed && (r += 2 * e),
					Math.abs(t.zoomPressed) > .01 && (r -= 5 * t.zoomPressed * Math.min(e, .1)),
					t.targetZoomLevel = t.targetZoomLevel * (1 + r),
				...
				t.enter = function (e) {
					...
					t.mouse = r.MouseHandler("camera_zoom_mouse", {
					...
					t.touch = r.TouchHandler("camera_zoom_touch", {
							multi: function (e, a, n, r, i, o, s) {
								if (2 == s && Math.abs(r) > n)
									return r > t.maxTouchDDist ? r = t.maxTouchDDist : r < -t.maxTouchDDist && (r = -t.maxTouchDDist), e > t.maxTouchDT && (e = t.maxTouchDT), t.inputSpeed = r * t.zoomVelocityTouch * e, !0
							}
						}),
					t.resetKeys = function () {
						t.inputSpeed = 0,
					...
					t.bindings = r.KeyBinder("camera_zoom_bindings", {
							SHIFT: a,
							W: n,
							S: i
						}),
			...
			e.exports = function (e) {
				...
				t.update = function (e, a) {
					...
					t.freeLook.update(e, a, r[2], r[0], r[1]),
					t.freeFly.update(e, a, t.getClosestSurface(e), r[2], r[0], r[1]),
			...
			e.exports = function (e) {
				...
				return t.updateFrameParent = function (e, a) {
					if (a = n.scene.get(a), a && a != t.frameParent) {
						var r = n.Frame();
						r.parent = t.frameParent,
						r.position = t.position,
						r.orientation = [0, 0, 0, 1],
						t.position = a.frame.convert(r, e.clock.time).position
					}
				},
				t.update = function (e, a, r, i, o, s) {
					var c = t.speedMod ? .01 : 1,
					l = c * n.math.clamp(r || 0, t.minimumSpeed, t.maximumSpeed),
					u = [0, 0, 0];
					t.forwardPressed ? u = n.math.vAdd(u, n.math.vMul(i, -l)) : t.backPressed && (u = n.math.vAdd(u, n.math.vMul(i, l))),
					...
					u = n.math.vAdd(u, n.math.vMul(i, l * M)),
				...
				t.enter = function (e) {
					...
					t.mouse = r.MouseHandler("camera_fly_mouse", {
							scroll: function (e, a, n, r, i) {
								return !!n && (t.zoomSpeed = i, !0)
							}
						}),
					t.touch = r.TouchHandler("camera_fly_touch", {
							multi: function (e, a, n, r, i, o, s) {
								if (2 == s && Math.abs(n) < .02)
									return t.zoomSpeed = r, !0
							}
						}),
					t.resetKeys = function () {
						t.zoomSpeed = 0,
					...
					t.bindings = r.KeyBinder("camera_fly_bindings", {
							LEFT_SHIFT: a,
							W: n,
							UP: n,
							S: i,
			...
			function n(e, t) {
				for (var a, n = null, r = Math.max(screen.height, screen.width) / 4, i = Math.min(screen.height, screen.width) / 2, o = 25, s = 0; s < e.length; s++)
					e[s] && (a = e[s][1].getBoundingClientRect(), a.left - o < r && a.right + o > r && a.bottom + o > i && a.top - o < i && (e[s][1].style.opacity > .4 || null === n || t[e[s][1].innerHTML] < t[n[1].innerHTML]) && (n = e[s]));
				return n
			}
			function r() {
				return g.currPair
			...
			function i(e, t, a) {
				function n(a) {
					if (a ? l.patch(u, a) : console.verboseWarn("scene/fetch: missing json from " + r), t.length > 1)
						return void i(e, t.slice(1), u);
					try {
						e.load(u)
					} catch (n) {
						console.exception("scene/fetch: Failed to load scene node " + e.name + 'from "' + r + '":', n)
					}
				}
				var r = t[0][0],
				o = t[0][1],
			...
			function o(e, t) {
				var a = r(e.name, t);
				return 0 !== a.length && (console.verbose && console.info("scene/fetch: Load node " + e.name + " from " + a), i(e, a), !0)
			}
			var s = a(3),
			c = a(4),
			l = a(38),
				...
				({
					1: [function (e, t, a) {
							...
							function c(e, t, a) {
								...
								i = isNaN(e.length) || e.length <= 0 ? 0 : e.length,
							...
							function l(e, t, a) {
								...
								r([e, t]).forEach(function (n) {
									i.push.apply(i, g(d(e[n], t[n], a.add(n))))
								}),
								i
							}
							function u(e, t, a) {
							...
							function d(e, t, a) {
								var n = i(e),
								r = i(t);
								return "array" == n && "array" == r ? c(e, t, a) : "object" == n && "object" == r ? l(e, t, a) : u(e, t, a)
							}
							var M = function (e, t) {
								if (Array.isArray(e))
									return e;
								if (Symbol.iterator in Object(e)) {
									for (var a, n = [], r = e[Symbol.iterator](); !(a = r.next()).done && (n.push(a.value), !t || n.length !== t); );
									return n
								}
					...
					2: [function (e, t, a) {
							...
							function i(e, t) {
								var a = Object.keys(e),
								n = Object.keys(t);
								return !!r(a, n) && a.every(function (a) {
									return o(e[a], t[a])
								})
							}
							function o(e, t) {
								return e === t || (Array.isArray(e) && Array.isArray(t) ? r(e, t) : Object(e) === e && Object(t) === t && i(e, t))
							}
							a.compare = o,
							Object.defineProperty(a, "__esModule", {
								value: !0
					...
					5: [function (e, t, a) {
							...
							function o(e, t) {
								var a = d.fromJSON(t.path).evaluate(e);
								return void 0 === a.value ? new p(t.path) : (r(a.parent, a.key), null)
							}
							function s(e, t) {
								var a = d.fromJSON(t.path).evaluate(e);
							...
							function c(e, t) {
								...
								if (void 0 === a.value)
									return new p(t.from);
								var i = d.fromJSON(t.path).evaluate(e);
								return void 0 === i.parent ? new p(t.path) : (r(a.parent, a.key), n(i.parent, i.key, a.value), null)
							}
							function l(e, t) {
								var a = d.fromJSON(t.from).evaluate(e);
								if (void 0 === a.value)
					...
					6: [function (e, t, a) {
							...
							a.Pointer = function () {
								...
								return i(e, {
									toString: {
										value: function () {
											return this.tokens.map(r).join("/")
										}
									},
									evaluate: {
										value: function (e) {
											for (var t = null, a = null, n = 1, r = this.tokens.length; n < r; n++)
			...
			function n() {
				...
				var e = r.app.core,
				t = i._queues = e.getRenderQueueList();
				i.queues = {
				...
				i.queues.addConstraint = function (e, t) {
					i._queues.addConstraint(i.queues[e], i.queues[t])
				},
				i.queues.activate = function (e) {
					i._queues.activate(i.queues[e])
				},
				i.queues.transparent.order = 1,
				i.queues.virtualDraw.order = 2,
				i.queues.panoImage.order = 3,
				i.queues.orbit.order = 4,
				i.queues.identity.order = 5,
				i.queues["default"].order = 6,
				i.queues.virtualScan.order = 7,
				i.queues.activate("transparent"),
				i.queues.activate("virtualDraw"),
				i.queues.activate("panoImage"),
				i.queues.activate("orbit"),
				i.queues.activate("identity"),
				i.queues.activate("virtualScan")
			}
			var r = a(4),
			i = {};
			i.init = function () {
			...
			!function () {
				...
				a(1).init(document.getElementById("canvas"), function () {
					...
					u.addTrigger(null, function () {
						...
						for (e in r)
							r[e].time = 0, n.addSurfaceLabel(u, r[e], "tier2", "location", {
								color: "#EEEEEE"
							});
						for (e in i)
							i[e].time = 0, n.addSurfaceLabel(u, i[e], "tier3", "location", {
								color: "#EEEEEE"
							});
						for (e in o)
					...
					i.actions.onPick = function (e, t, a) {
						if (!e || !e.node || "interactable" in e.node && !e.node.interactable)
							return !1;
						if ("Earth" == e.node.name) {
							var r = l.getCorrectedPositionNDC(t, a),
							s = n.getLatLongFromEllipsoidSelection(l._camera, e.node, r[0], r[1]);
							if (s) {
								var c = [180 * s[0] / Math.PI, 180 * s[1] / Math.PI];
								n.locationClicked(c)
							}
						} else
							i.actions.onClick(e.node, o.speed.standard, !1)
					},
					i.actions.backgroundSingleTap = function (e, t, a, n, r, o, s, c, l, u) {
						i.actions.onPick(u, s, c)
					},
					i.actions.backgroundDoubleTap = function (e, t, a, n, r, i, o, s, c, l) {
					...
					window.setTimeout(function () {
						t.applyOrbitCam(l, r.initialCamera())
					}, 2e3),
			...
			M.init = function (e) {
				Object.keys(M).indexOf(r.camera.type) < 0 && (console.error("ranger/camera: Invalid camera type " + r.camera.type), r.camera.type = "Orbit");
				var t = n.clock.Clock(r.camera.time, r.camera.rate);
				e.initCamera({
					clock: t,
					target: n.scene.get(r.camera.target)
				}),
				e.setCamera(M[r.camera.type](r.camera)),
				M.vrBindings = i.KeyBinder("vr_bindings", {
						M: function () {
							r.stereo = !r.stereo,
			...
			M.updateCameraType = function (e) {
				...
				if (r.vr) {
					if (r.camera.type = "FreeFly", t = {
						...
						}, e.setCamera(M[r.camera.type](t)), e._camera.projectionDirty = !0, e.vrDevice.capabilities.canPresent) {
						var a = {};
					...
					i = n.ellipsoid ? Math.max(n.ellipsoid[0], n.ellipsoid[1], n.ellipsoid[2]) : 1,
					c = .05,
					l = {
						frame: e.cameraState.frame,
						target: n,
			...
			e.exports = function (e, t, a, o, s, c, l) {
				...
				u.update = function (e) {
					...
					if (t.parent = u.orientingNode, t = u.targetNode.frame.convert(t, e.clock.time), !(n.math.vNorm(t.position) < 1e-7)) {
						...
						r = u.targetNode.frame.convert(r, e.clock.time);
						var i = n.math.vNormalized(n.math.vSub(r.position, t.position));
						i = n.math.vNormalized(n.math.vSub(i, n.math.vMul(a, n.math.vDot(a, i))));
						var o = n.math.cross(i, a),
						s = n.math.vMul(i, u.radius);
				...
				u.enter = function (e) {
					u.mouse = r.MouseHandler("camera_mouse", {
							drag: function (e, t, a) {
								return t && u.yaw(-t * u.yawSpeed),
								a && u.pitch(a * u.pitchSpeed),
								!0
							},
							scroll: function (e, t, a, n, r) {
								return r && u.zoom(r * u.zoomFactor * u.radius),
								!0
							}
						}),
					u.bindings = r.KeyBinder("camera_bindings", {
							A: function () {
			...
			function r(e) {
				if (void 0 === te.update.send)
					return void(he || (console.verboseError("__ranger.update.send is undefined. Ranger will not send messages until defined."), he = !0));
				var t = {
					message: e,
					path: "/eclipse",
					success: !0
			...
			function o() {
				K = new te.Renderable(te.app.core, new te.DataContext(te.app), ye.renderableAttributes),
				ye.renderable = K,
				te.scene.fixedRenderables.Headlight = ye
			}
			function s() {
				var e = te.scene.get("Earth"),
				t = te.scene.get("Moon"),
				a = t.frame.get(te.app.getWin()._camera.clock.time),
				n = e.frame.convert(a, te.app.getWin()._window.camera).position;
				a = e.frame.get(te.app.getWin()._camera.clock.time);
				var r = e.frame.convert(a, te.app.getWin()._window.camera).position,
				i = te.math.vNorm(te.math.vSub(n, r));
				return console.verboseLog("Requested Distance Between Earth and Moon, Distance:", i),
				i
			}
			function c(e) {
				te.scene.fixedRenderables.Headlight.enabled = e
			}
			function l(e) {
				return console.verboseLog("Setting Default Eclipse Settings for View: ", e),
				le.revertViewports(),
				$.setTime(se.viewSettings[e].defaultTime),
				$.setRate(se.viewSettings[e].defaultTimeRate),
				le.updateBrushTimeParams([re.ET2UTC(se.viewSettings[e].minTime), re.ET2UTC(se.viewSettings[e].maxTime)]),
				se.viewSettings[e].displayPip ? le.unhidePip : (le.hidePip(), function () {})
			}
			function u(e, t) {
				if (e.constructor !== {}
					.constructor)
				...
				a in ce.switchTo ? !function () {
					console.verboseLog("Setting View to: ", a, "with toScale: ", ge);
					var e = l(a);
					de = a,
					te.updates.components.eclipse.stateConstraints.setState("settingView", !0),
					"EarthMoon" === de ? te.updates.components.eclipse.stateConstraints.setState("earthMoonView", !0) : te.updates.components.eclipse.stateConstraints.setState("earthMoonView", !1),
					"EarthMoonSun" === de ? te.updates.components.eclipse.stateConstraints.setState("earthMoonSunView", !0) : te.updates.components.eclipse.stateConstraints.setState("earthMoonSunView", !1),
					ce.setTransitionComplete(function () {
						te.updates.components.eclipse.stateConstraints.setState("settingView", !1),
						console.verboseLog("Transition to new View Completed."),
						r({
							setViewDone: !0
						}),
						ge !== Me && ge === !1 && (Me = ge, ue.scalePlanets(ge)),
						e(),
						t.resolve("Transition to new View Completed.")
					}),
					ue.updateTransitionScale(ge, a),
					ge === Me || ge === !1 ? ce.switchTo[a](se.viewSettings[a].defaultFOV) : (ue.scalePlanets(ge), Me = ge)
				}
				() : (console.verboseError("Unknow view: ", a), t.reject("Unknow view: " + a))
			}
			function d(e) {
				var t = te.scene.get("Earth");
				if (null !== Ae.earth && null !== Ae.politicalEarth)
					return e ? t.renderables.getRenderable("geoid", "model").material = Ae.politicalEarth : t.renderables.getRenderable("geoid", "model").material = Ae.earth, void(t.renderables.getRenderable("atmosphere", "model").enabled = !e);
				if (e) {
					...
					Ae.earth = t.renderables.getRenderable("geoid", "model").material,
					a = ne.replace(a),
					t.renderables.getRenderable("geoid", "model").updateMaterial(te.app.core, a),
			...
			function M(e, t) {
				...
				var r;
				for (var i in Ne)
					r = "", pe && (r += Ne[i].name), me && (pe ? r = r + "<br />" + Ne[i].time : r += Ne[i].time), ee.updateLabel(a, i, Ne[i].latLng, {
						Text: r
					}, !1, Ne[i].lodKey);
				t.resolve()
			}
			...
			function p(e, t) {
				var a = re.UTC2ET(e),
				n = se.validateTime(de, a);
				if (n)
					$.setTime(a), $.pip && ($.pip._camera.clock = {
							time: {
								value: a
							},
							rate: 0
					...
					var r = [re.ET2UTC(se.viewSettings[de].minTime), re.ET2UTC(se.viewSettings[de].maxTime)];
					console.verboseError("Invalid: Time needs to be in Interval [", r[0], ",", r[1], "]. Data received: ", e),
					t.reject("Invalid: Time needs to be in Interval [" + r[0] + "," + r[1] + "]. Data received: " + e)
				}
			}
			function m(e, t) {
				var a = se.validateTimeRate(de, e);
				if (a)
					$.setRate(e), console.verboseLog("Setting Time Rate to: ", e), t.resolve("Setting Time Rate to: " + e);
				else {
					var n = [se.viewSettings[de].minTimeRate, se.viewSettings[de].maxTimeRate];
			...
			function A(e, t) {
				var a = se.validateFOV(de, e);
				if (a)
					$._camera.fov = e, console.verboseLog("Setting FOV of Camera to: ", e), t.resolve("Setting FOV of Camera to: " + e);
				else {
					var n = [se.viewSettings[de].minFOV, se.viewSettings[de].maxFOV];
			...
			function f(e, t) {
				...
				if (le.isOnscreen()) {
					var a = e ? le.telescopeFov : le.normalFov;
					le.viewsAreSwapped() ? $._camera.fov = a : le.getSubWindow()._camera.fov = a,
			...
			function D(e, t) {
				...
				var a = te.scene.get("ConePenumbra");
			...
			function T(e, t) {
				return "boolean" != typeof e ? (console.verboseError("Invalid: toScale must be a boolean. Data received: ", e), void t.reject("Invalid: toScale must be a boolean. Data received: " + e)) : void(e !== Me && (ge = e, ue.updateTransitionScale(ge, de), ge === !0 ? (ue.scalePlanets(ge), Me = ge) : de in ce.switchTo && ce.switchTo[de](se.viewSettings[de].defaultFOV), e ? (console.verboseLog("Setting Scene to be to Scale. Data received: ", e), t.resolve("Setting Scene to be to Scale. Data received: ", e)) : (console.verboseLog("Setting Scene to not be to Scale. Data received: ", e), t.resolve("Setting Scene to not be to Scale. Data received: ", e))))
			}
			function y() {
				return Me
			}
			function L(e, t) {
				return le.isOnscreen() ? (console.verboseLog("Swapping Displays"), le.swapPip(), void t.resolve(e + "Swapping Displays")) : (console.verboseError("Error: PIP is not on the screen."), void t.reject("Error: PIP is not on the screen."))
			}
			function w(e) {
				return e in De
			}
			function I(e) {
				e && e.popup && (fe[e.id].popupDisplayed = !0, e.popup.style.display = "")
			}
			function E(e) {
				e && e.popup && (fe[e.id].popupDisplayed = !1, e.popup.style.display = "none")
			}
			function j(e, t, a, n) {
			...
			function x(e, t) {
				...
				var r = n.getElementsByTagName("style")[0];
				r.innerHTML = "",
			...
			function b(e, t) {
				...
				a.addTrigger(null, function () {
					...
					ee.addLabel(a, s.id, s.latLng, s, "markers"),
					fe[s.id] = {
						params: s,
						div: null
					},
			...
			function C(e, t) {
				var a = te.scene.get("Earth");
				a.addTrigger(null, function () {
					return e in fe ? (ee.removeLabel(a, e, "markers"), delete fe[e], void t.resolve("Marker " + e + " Removed Successfully.")) : (console.verboseError("Invalid: Attempted to remove a non-existing Marker. Data received: ", e), void t.reject("Invalid: Attempted to remove a non-existing Marker. Data received: " + e))
				})
			}
			function S(e, t) {
				if (e.constructor !== {}
				...
				a.addTrigger(null, function () {
					if (!(e.id in fe))
						return console.verboseError("Invalid: Attempted to set a non-existing Marker. Data received: ", e.id, ". Attempting to Add Marker instead."), void b(e, t);
					var n = fe[e.id];
					...
					ee.updateLabel(a, n.params.id, n.params.latLng, n.params, !1, "markers"),
					j(n.div, n.params.name, n.params.locationId, w(e.locationId)),
					n.params.popupDisplayed ? I(n.div) : E(n.div),
					n.params.color && x(n.div, n.params.color),
			...
			function k(e, t) {
				return e in fe ? (I(fe[e].div), console.verboseLog("Popup for Marker", e, "Displayed"), void t.resolve("Popup for Marker" + e + "Displayed")) : (console.verboseError("Invalid: Attempted to display Popup of a non-existing Marker. Data received: ", e), void t.reject("Invalid: Attempted to display Popup of a non-existing Marker. Data received: " + e))
			}
			function Q(e, t) {
				return e in fe ? (E(fe[e].div), console.verboseLog("Popup for Marker", e, "Hidden"), void t.resolve("Popup for Marker" + e + "Hidden")) : (console.verboseError("Invalid: Attempted to hide Popup of a non-existing Marker. Data received: ", e), void t.reject("Invalid: Attempted to hide Popup of a non-existing Marker. Data received: " + e))
			}
			function U(e, t) {
				if (e.constructor !== {}
					.constructor)
				...
				o.addTrigger(null, function () {
					if (w(e.id)) {
						...
						"name" in e && "location" in e ? (r = e.id, n = e.name, a = e.location, i = !0) : (console.verboseError("Error: Could not set Marker, either location does not exist or missing information. Data received: ", e), t.reject("Error: Could not set Marker, either location does not exist or missing information. Data received: " + JSON.stringify(e)));
					if (i) {
						var s = {
							id: "Eclipse_Marker",
							locationId: e.id,
			...
			function B(e, t) {
				...
				for (var i in fe)
					fe[i].div && fe[i].div.popup && fe[i].div.locationId === a && j(fe[i].div, n, a, !0);
				t.resolve(e)
			}
			...
			function P(e, t) {
				if (w(e)) {
					...
					var a = De[e].name;
					for (var n in fe)
						fe[n].div && fe[n].div.popup && fe[n].div.locationId === e && j(fe[n].div, a, e, !1);
					delete De[e],
					t.resolve({
						id: e,
						name: a
			...
			function F() {
				...
				te.scene.paintersSort = function (a, n) {
					var r = [],
					i = [];
					if ("Earth" === de || "Moon" === de)
						i = e;
					else {
						var o = te.scene.get("Sun").frame.get(n.clock.time),
						s = {},
						c = {};
						"undefined" != typeof o ? (s = te.scene.get("Earth").frame.convert(o, n), c = te.scene.get("Moon").frame.convert(o, n)) : (s = {
								position: [0, 0, 0],
								orientation: [0, 0, 0, 1]
							}, c = {
								position: [0, 0, 0],
						...
						var l = te.scene.get("Earth").frame.convert({
								parent: te.scene.cameraData[n.id].attachedNode,
								position: n.frame.position,
								orientation: n.frame.orientation
							}, n),
						u = te.scene.get("Moon").frame.convert({
								parent: te.scene.cameraData[n.id].attachedNode,
								position: n.frame.position,
								orientation: n.frame.orientation
							}, n),
						d = te.math.angleBetweenVectors(s.position, l.position),
						M = te.math.angleBetweenVectors(c.position, u.position);
						i = d < Math.PI / 2 && M < Math.PI / 2 ? t : e
					}
					for (var g in i) {
						var p = [];
						for (var m in i[g]) {
			...
			function V(e) {
				...
				o(),
				ee = ae(),
				$.endFrameUpdates.timeLoop = function (e, t) {
					var a = t.getTime();
					a > se.viewSettings[de].maxTime && (a = se.viewSettings[de].minTime),
					a < se.viewSettings[de].minTime && (a = se.viewSettings[de].maxTime),
					t.setTime(a)
				},
				ce.setTransitionComplete(function () {
					te.updates.components.eclipse.stateConstraints.setState("settingView", !1),
				...
				$.endFrameUpdates.reportCurrentFPS = function () {
					if (te.settings.fps) {
						var e = Date.now();
						if (Te.currentCount++, e - Te.lastTime > Te.interval) {
							if (Te.lastTime = e, Te.frameRate.push(Math.round((Te.currentCount - Te.lastCout) / Te.interval * 1e3)), Te.lastCout = Te.currentCount, Array.isArray(Te.frameRate) && Te.frameRate.length > 0) {
								var t = 0;
								Te.frameRate.forEach(function (e) {
									t += e
								}),
								console.log("After " + Math.round((e - Te.startTime) / 1e3) + "s, avg FPS is " + Math.round(t / Te.frameRate.length))
							}
							console.log("FPS " + Te.frameRate[Te.frameRate.length - 1])
						}
					}
				},
				F(),
				ue.initializeScaling(ce),
				le.setStartDragHandler(G),
				le.updateBrushTimeParams([re.ET2UTC(se.viewSettings[de].minTime), re.ET2UTC(se.viewSettings[de].maxTime)])
			}
			function W(e) {
				var t = {};
				t.markerClicked = e,
			...
			function H(e) {
				var t = {};
				if (t.locationClicked = e, console.verboseLog("Location Clicked: ", e), "debug" in te.settings && te.settings.debug) {
					var a = {};
					return a.id = "debug-" + ve.count,
					a.name = "debug-" + ve.count,
					a.location = e,
					a.displayPopup = !0,
					void te.update({
						eclipse: {
			...
			function Z(e) {
				var t = {};
				if (t.locationSelectedToAdd = e, console.verboseLog("location Selected to Add: ", e), "debug" in te.settings && te.settings.debug && "Eclipse_Marker" in fe) {
					var a = {};
					return a.id = e,
					a.name = fe.Eclipse_Marker.params.Text,
					a.location = fe.Eclipse_Marker.params.latLng,
					te.update({
						eclipse: {
							addLocation: a
						}
					}),
					void(ve.count = ve.count + 1)
				}
				r(t)
			}
			function X(e) {
				...
				"debug" in te.settings && te.settings.debug ? void te.update({
					eclipse: {
						removeLocation: e
					}
				}) : void r(t)
			...
			function q(e, t, a, n) {
				...
				i.className = "map_popover eclipse_modal light_background",
				o.className = "location_title",
				s.className = "location_arrow",
				c.className = "button",
				l.className = "close_btn",
				u.className = "icon",
				i.id = e.id + "-marker-popup",
				o.innerHTML = n,
				...
				i.style.transform = "translate(-50%, -100%)",
				i.style["max-width"] = "none",
				c.addEventListener("click", function (t) {
					t.stopPropagation(),
					c.locationExists ? X(c.locationId) : Z(c.locationId),
					E(e)
				}, !1),
			...
			function J(e, t, a, n) {
				var r = 0,
				i = 0;
				e.aspect >= 1 ? (r = Math.atan(Math.tan(e.fov / 2) * e.aspect * -a), i = e.fov / 2 * n) : (r = e.fov / 2 * -a, i = Math.atan(Math.tan(e.fov / 2) / e.aspect * n));
				var o = te.scene.cameraData[e.id].attachedNode.frame.convert(te.scene.get("Earth").frame.get(e.clock.time), te.app.getWin()._window.camera),
				s = [0, 0, 1],
				c = Math.tan(r) * s[2] + s[0],
				l = -1 * Math.tan(i) * s[2] + s[1],
				u = te.math.vMul(te.math.vNormalized([c, l, s[2]]), -1),
				d = te.math.qMulV(te.math.qMulQ(te.math.conjugate(o.orientation), e.frame.orientation), u),
				M = te.scene.get("Earth").frame.convert({
						parent: te.scene.cameraData[e.id].attachedNode,
						position: e.frame.position,
						orientation: e.frame.orientation
					}, e).position;
				d = te.math.vMul(d, 1e6);
				var g = te.math.lineEllipsoidIntersection(t.ellipsoid, M, d);
				if (0 !== g.size()) {
					var p = te.math.vAdd(M, te.math.vMul(d, g.get(0))),
					m = te.math.rectangularToGeodetic(t.ellipsoid, p);
					return [m[1], m[0]]
				}
			}
			var $,
			...
			te.updates = a(19),
			te.updates.components.eclipse = new oe,
			te.updates.components.eclipse.stateConstraints.addState("settingView", !1, ["setView", "toScale", "swapDisplays", "setTime", "setTimeRate", "setFOV"]),
			te.updates.components.eclipse.stateConstraints.addState("earthMoonView", !1, ["setEclipseViewport"]),
			te.updates.components.eclipse.stateConstraints.addState("earthMoonSunView", !1, ["setEclipseViewport"]);
			var Le = new oe;
			Le.components.FOV = function (e, t) {
				var a = {};
				a.FOV = $._camera.fov,
				r(a),
				t.resolve(a)
			},
			Le.components.maxFOV = function (e, t) {
				var a = {};
				a.maxFOV = se.viewSettings[de].maxFOV,
				r(a),
				t.resolve(a)
			},
			Le.components.minFOV = function (e, t) {
				var a = {};
				a.minFOV = se.viewSettings[de].minFOV,
				r(a),
				t.resolve(a)
			},
			Le.components.timeRate = function (e, t) {
				var a = {};
				a.timeRate = $.getRate(),
				r(a),
				t.resolve(a)
			},
			Le.components.maxTimeRate = function (e, t) {
				var a = {};
				a.maxTimeRate = se.viewSettings[de].maxTimeRate,
				r(a),
				t.resolve(a)
			},
			Le.components.minTimeRate = function (e, t) {
				var a = {};
				a.minTimeRate = se.viewSettings[de].minTimeRate,
				r(a),
				t.resolve(a)
			},
			Le.components.time = function (e, t) {
				var a = {};
				a.time = re.ET2UTC($.getTime()),
				r(a),
				t.resolve(a)
			},
			Le.components.maxTime = function (e, t) {
				var a = {};
				a.maxTime = re.ET2UTC(se.viewSettings[de].maxTime),
				r(a),
				t.resolve(a)
			},
			Le.components.minTime = function (e, t) {
				var a = {};
				a.minTime = re.ET2UTC(se.viewSettings[de].minTime),
				r(a),
				t.resolve(a)
			},
			Le.components.timeRateValues = function (e, t) {
				var a = {};
				a.timeRateValues = se.viewSettings[de].timeRateValues,
				r(a),
				t.resolve(a)
			},
			Le.components.earthMoonDistance = function (e, t) {
				var a = {};
				a.earthMoonDistance = s(),
				r(a),
				t.resolve(a)
			},
			Le.components.cameraState = function (e, t) {
				ie.cameraState(e, t)
			},
			Le.components.cameraIds = function (e, t) {
				ie.cameraIds(e, t)
			},
			te.updates.components.eclipse.components.addLocation = B,
			te.updates.components.eclipse.components.removeLocation = P,
			te.updates.components.eclipse.components.getInfo = R,
			te.updates.components.eclipse.components.headLightEnabled = h,
			te.updates.components.eclipse.components.keyboardEventsEnabled = Y,
			te.updates.components.eclipse.components.politicalMapEnabled = v,
			te.updates.components.eclipse.components.setFOV = A,
			te.updates.components.eclipse.components.setLabelDisplay = M,
			te.updates.components.eclipse.components.setPenumbraColor = D,
			te.updates.components.eclipse.components.setEclipseViewportMode = f,
			te.updates.components.eclipse.components.addMarker = b,
			te.updates.components.eclipse.components.removeMarker = C,
			te.updates.components.eclipse.components.updateMarker = S,
			te.updates.components.eclipse.components.setMarker = U,
			te.updates.components.eclipse.components.setEclipseViewport = z,
			te.updates.components.eclipse.components.removeEclipseViewport = O,
			te.updates.components.eclipse.components.setTime = p,
			te.updates.components.eclipse.components.setTimeRate = m,
			te.updates.components.eclipse.components.setUmbraColor = N,
			te.updates.components.eclipse.components.setView = u,
			te.updates.components.eclipse.components.shadowLabelsEnabled = g,
			te.updates.components.eclipse.components.swapDisplays = L,
			te.updates.components.eclipse.components.toScale = T,
			te.updates.components.eclipse.components.showMarkerPopup = k,
			te.updates.components.eclipse.components.hideMarkerPopup = Q,
			te.updates.components.eclipse.components.setCameraState = ie.setCameraState,
			e.exports = {
				init: V,
				addEarthLoadedNotification: i,
				sendMessage: r,
				locationClicked: H,
				locationSelectedToAdd: Z,
				locationSelectedForRemoval: X,
				getLatLongFromEllipsoidSelection: J,
				isNormalScale: y,
				attachPopup: q,
				hasLocation: w,
				addSurfaceLabel: _,
				displayMarkerPopup: I,
				removeMarkerPopup: E,
				showMarkerPopup: k,
				hideMarkerPopup: Q,
				markerClicked: W,
				markerRenderables: fe,
				updateMarkerColor: x
			}
		}, function (e, t, a) {
			var n = a(4);
			e.exports = function () {
				...
				e.getTranslateFromLatLng = function (e, t) {
					...
					r = n.math.geodeticToRectangular(e.ellipsoid, [a[0], a[1], .001]);
					return r
				},
				e.addNodeToSurfaceLabels = function (t, a, n) {
					...
					for (var r in e.defaultLodSetting.rangeParams)
						e.surfaceLabelMap[t.name].lodSettings.rangeParams[r] = e.defaultLodSetting.rangeParams[r];
				...
				e.addLabel = function (t, a, n, r, i) {
					var o = e.getNodeSurfaceLabels(t);
					if (a in o.labels)
						return console.warn("Attempting to add a new label with an id of an existing Label, updating existing Label instead."), void e.updateLabel(t, a, n, r, !0, i);
					var s,
					c = null,
					l = null,
					u = {};
					...
					u.latLng = n,
					i || (i = o.lodSettings.lodKey),
					e.availableRenderables.length > 0 && (c = e.availableRenderables.pop().renderable, c.data = u),
					l = c ? t.renderables.emplaceRenderable(u, c, a, i) : t.renderables.addRenderable(u, a, i),
					t.renderables.getRenderable(a, i),
					t.renderables.updateRenderableTransform(u.transform, l, i),
					o.labels[a] = {},
				...
				e.removeLabel = function (t, a, n) {
					...
					var i = r.labels[a].renderableName;
					n || (n = r.lodSettings.lodKey);
					var o = t.renderables.removeRenderable(i, n),
					s = r.labels[a].json;
					return delete r.labels[a],
					o.json && o.renderable && e.availableRenderables.push(o),
					s
				},
				e.updateLabelLatLng = function (t, a, n, r) {
					...
					c = i.labels[a].renderableName;
					r || (r = i.lodSettings.lodKey),
					t.renderables.updateRenderableTransform(s, c, r)
				},
				e.updateLabel = function (t, a, n, r, i, o) {
				...
				e.getLabelData = function (t, a) {
					...
					var r = {};
					for (var i in n.labels[a].json)
						r[i] = n.labels[a].json[i];
					return r.renderableName = n.labels[a].renderableName,
					r
				},
				e
			}
			...
			function n(e, t) {
				if (e.id) {
					...
					if (a) {
						...
						t.resolve(r),
						"debug" in s.settings && s.settings.debug && window.savedCameraStates.push(r)
					} else
					...
					if (a) {
						var n = function () {
							...
							var i = {
								...
								after: function () {
									t.resolve("Transition to new camera state " + u[r].name + " completed.")
								}
							};
							d(e.id).setCamera(c.trackingTransition(i))
						}
						();
			...
			x = function () {
				...
				c = function (r) {
					...
					if (a) {
						o && (o = !1, L());
						var c =  - (s - t),
						l = c / r.target.offsetWidth,
						u = i.ET2UTC(e.getTime()),
				...
				M = function (e) {
					...
					for (a = 0; a < t.length; a++)
						n = d(t[a].identifier, r), n >= 0 ? r.splice(n, 1, {
				...
				p = function (e) {
					...
					for (a = 0; a < n.length; a++)
						t = d(n[a].identifier, r), t >= 0 && r.splice(t, 1);
					o = !0
				};
				return {
					mouseDown: s,
			...
			S = function (e, t) {
				...
				I() ? (p.setCamera(r.getTelescopeCamera(t)), u.div.className = D) : (u.setCamera(r.getTelescopeCamera(t)), u.div.className = D + " pip-interactable"),
				u.resize(),
			...
			O = function () {
				C() && (2 != n.app.windows.length && console.warn("pip.js: Unexpected number of cameras, hidePip() is popping off an unknown camera."), n.app.windows.pop(), d.remove(), u = null)
			},
			k = function () {
				h.locationName && h.latLng && S(h.locationName, h.latLng)
			},
			Q = function (e, t) {
				h.locationName = e,
				h.latLng = t
			...
			m = {
				...
				Moon: function (e) {
					...
					r = t.frame.convert(r, o.app.getWin()._camera);
					var c = o.math.lookRotation(o.math.vMul(o.math.vNormalized(r.position), 1), [0, 0, 1]),
					...
					r = n.frame.convert(r, o.app.getWin()._camera);
					var f = {
						frame: o.app.getWin().cameraState.frame,
						target: n,
			...
			r = a(27),
			i = function (e, t, a, r) {
				var i = r.frame.get(t.clock.time);
				i = a.frame.convert(i, t);
				var o = n.math.vSub(i.position, e),
			...
			e.exports = function (e) {
				...
				return t.update = function () {
					return function (e) {
						var r = i(e.frame.position, e, n, a);
						t.frame.orientation = r
					}
				}
				(t.update),
				t
			},
			e.exports.getOrientationForPosition = i
		}, function (e, t, a) {
			var n = a(4),
			r = a(26);
			e.exports = function (e) {
				...
				o = e.position;
				return t.update = function (e) {
					var r = a.frame.get(e.clock.time);
					r = i.frame.convert(r, e);
					var s = n.math.vSub(r.position, o),
			...
			function s(e, t, a, n) {
				var r = function o(r) {
					if (o.count = ++o.count || 1, 1 === o.count && (o.clockStart = Date.now(), o.clockEnd = o.clockStart + a, o.exiting = !1), Date.now() <= o.clockEnd) {
						...
						c = 1;
						c = (t - e) * s + e,
						r.renderables.transform.scale = c,
						r.ellipsoid[0] = m[r.name][0] * c,
						r.ellipsoid[1] = m[r.name][1] * c,
						r.ellipsoid[2] = m[r.name][2] * c,
						r.renderables.updateTransforms()
					} else
						o.exiting || (o.exiting = !0, r.renderables.transform.scale = t, r.renderables.transform.enabled = n, r.ellipsoid[0] = m[r.name][0] * t, r.ellipsoid[1] = m[r.name][1] * t, r.ellipsoid[2] = m[r.name][2] * t, r.renderables.updateTransforms(), d.app.addCallbackEvent({
								callback: i,
								params: [r]
							}))
				};
			...
			function c(e, t, a, n) {
				var r = function i(r) {
					if (i.count = ++i.count || 1, 1 === i.count && (i.clockStart = Date.now(), i.clockEnd = i.clockStart + a, i.exiting = !1), Date.now() <= i.clockEnd) {
						var s = (Date.now() - i.clockStart) / (i.clockEnd - i.clockStart),
						c = 1;
						c = (t - e) * s + e,
						r.renderables.transform.orbitScale = c
					} else
						i.exiting || (i.exiting = !0, r.renderables.transform.orbitScale = t, r.renderables.transform.enabled = n, d.app.addCallbackEvent({
								callback: o,
								params: [r]
							}))
				};
				...
				value: {
					...
					channel: {
						color: {
							...
							uniform: {
								"float": ["moonRadius", "sunRadius", "naturalMode", "bendPercent1", "bendPercent2"],
			...
			(function (t) {
				...
				e.exports = function (e, a, c, l, u, d) {
					...
					var g = {
						...
						postCameraUpdates: {},
						endFrameUpdates: {},
						inputHandlers: [r.KeyBinder("bindings")],
						cursorPosition: [0, 0],
						backgroundHandlers: [],
						touchDown: !1,
						allowKeypress: !0
					...
					t.window && (t.window.addEventListener("resize", M), g.element.addEventListener("mouseout", r.eventHandlers.mouseOut), g.element.addEventListener("mousemove", r.eventHandlers.mouseMove), t.window.addEventListener("keydown", r.eventHandlers.keyPress), g.element.addEventListener("mousedown", r.eventHandlers.mouseDown), g.element.addEventListener("mouseup", r.eventHandlers.mouseUp), g.element.addEventListener("DOMMouseScroll", r.eventHandlers.scroll), g.element.addEventListener("mousewheel", r.eventHandlers.scroll), g.element.addEventListener("wheel", r.eventHandlers.scroll), g.element.addEventListener("touchstart", r.eventHandlers.touchStart), g.element.addEventListener("touchmove", r.eventHandlers.touchMove), g.element.addEventListener("touchend", r.eventHandlers.touchEnd), g.element.addEventListener("touchcancel", r.eventHandlers.touchCancel), g.element.addEventListener("touchleave", r.eventHandlers.touchCancel), M()),
					g.pick = function () {
					...
					g.initCamera = function (e) {
						...
						g._camera.stereoBindings = r.KeyBinder("stereo_bindings", {
								P: function () {
						...
						i.generateLabelSystem(g, g._camera)
					},
					...
					g.passInputEvent = function (e, t) {
						...
						for (a in g.inputHandlers)
							try {
								...
								console.exception('ranger/Window: Updating "' + g.title + '" failed in input handler "' + g.inputHandlers[a].name + '": ', r)
							}
						if (!n)
					...
					g.loop = function (e, t, a, n) {
						try {
							...
							(++a[n].failed < 3 || g.doDebug) && console.exception('ranger/Window: Updating "' + g.title + '" failed ' + (a[n].failed < 2 ? "" : "(supressing messages)") + " in " + e + ': "' + n + '": ', r)
						}
					},
			...
			function i(e) {
				n(),
				e.endFrameUpdates.loadingAnimation = r
			}
			var o,
			s = a(4),
			...
			({
				1: [function (e, t, a) {
						...
						t.exports = r() ? Object.assign : function (e, t) {
							for (var a, r, s = n(e), c = 1; c < arguments.length; c++) {
				...
				2: [function (e, t, a) {
						...
						n.prototype.requestPresent = function (e) {
							...
							new Promise(function (n, r) {
								...
								function o() {
									a.waitingForPresent_ && (a.removeFullscreenWrapper(), a.removeFullscreenListeners_(), a.wakelock_.release(), a.waitingForPresent_ = !1, a.isPresenting = !1, r(new Error("Unable to present.")))
								}
								if (!a.capabilities.canPresent)
									return void r(new Error("VRDisplay is not capable of presenting."));
								if (0 == e.length || e.length > a.capabilities.maxLayers)
									return void r(new Error("Invalid number of layers."));
								var c = e[0];
								if (!c.source)
									return void n();
								...
								if (a.layer_ = {
									...
									a.addFullscreenListeners_(A, i, o),
								...
								a.waitingForPresent_ || s.isIOS() || (s.exitFullscreen(), r(new Error("Unable to present.")))
							})
						},
						...
						t.exports.VRDevice = r,
						t.exports.HMDVRDevice = i,
				...
				3: [function (e, t, a) {
						function n(e) {
							...
							i.isIOS() || (this.realCanvasWidth = Object.getOwnPropertyDescriptor(e.canvas.__proto__, "width"), this.realCanvasHeight = Object.getOwnPropertyDescriptor(e.canvas.__proto__, "height")),
							this.isPatched = !1,
							...
							this.program = i.linkProgram(e, s, c, this.attribs),
							...
							this.patch(),
							this.onResize(),
							WebVRConfig.CARDBOARD_UI_DISABLED || (this.cardboardUI = new r(e))
						}
						var r = e("./cardboard-ui.js"),
						i = e("./util.js"),
						...
						n.prototype.patch = function () {
							if (!this.isPatched) {
								...
								t = this.gl.canvas,
								a = this.gl;
								i.isIOS() || (t.width = i.getScreenWidth() * this.bufferScale, t.height = i.getScreenHeight() * this.bufferScale, Object.defineProperty(t, "width", {
										configurable: !0,
										enumerable: !0,
										get: function () {
								...
								a.colorMask = function (t, n, r, i) {
									e.colorMask[0] = t,
									e.colorMask[1] = n,
									e.colorMask[2] = r,
									e.colorMask[3] = i,
									e.realColorMask.call(a, t, n, r, i)
								},
								this.clearColor = a.getParameter(a.COLOR_CLEAR_VALUE),
								a.clearColor = function (t, n, r, i) {
									e.clearColor[0] = t,
									e.clearColor[1] = n,
									e.clearColor[2] = r,
									e.clearColor[3] = i,
									e.realClearColor.call(a, t, n, r, i)
								},
								this.viewport = a.getParameter(a.VIEWPORT),
								a.viewport = function (t, n, r, i) {
									e.viewport[0] = t,
									e.viewport[1] = n,
									e.viewport[2] = r,
									e.viewport[3] = i,
									e.realViewport.call(a, t, n, r, i)
								},
								this.isPatched = !0,
								i.safariCssSizeWorkaround(t)
							}
						},
						n.prototype.unpatch = function () {
							if (this.isPatched) {
								var e = this.gl,
								t = this.gl.canvas;
								i.isIOS() || (Object.defineProperty(t, "width", this.realCanvasWidth), Object.defineProperty(t, "height", this.realCanvasHeight)),
						...
						n.prototype.submitFrame = function () {
							...
							if (WebVRConfig.DIRTY_SUBMIT_FRAME_BINDINGS || a.push(e.CURRENT_PROGRAM, e.ARRAY_BUFFER_BINDING, e.ELEMENT_ARRAY_BUFFER_BINDING, e.TEXTURE_BINDING_2D, e.TEXTURE0), o(e, a, function (e) {
									...
									t.realColorMask.call(e, !0, !0, !0, !0),
									t.realViewport.call(e, 0, 0, e.drawingBufferWidth, e.drawingBufferHeight),
									(t.ctxAttribs.alpha || i.isIOS()) && (t.realClearColor.call(e, 0, 0, 0, 1), e.clear(e.COLOR_BUFFER_BIT)),
						...
						n.prototype.updateDeviceInfo = function (e) {
							...
							o(t, n, function (t) {
								...
								if (t.bindBuffer(t.ARRAY_BUFFER, a.vertexBuffer), t.bufferData(t.ARRAY_BUFFER, n, t.STATIC_DRAW), !a.indexCount) {
									var r = a.computeMeshIndices_(a.meshWidth, a.meshHeight);
									t.bindBuffer(t.ELEMENT_ARRAY_BUFFER, a.indexBuffer),
									t.bufferData(t.ELEMENT_ARRAY_BUFFER, r, t.STATIC_DRAW),
									a.indexCount = r.length
								}
							})
						},
						n.prototype.computeMeshVertices_ = function (e, t, a) {
							for (var n = new Float32Array(2 * e * t * 5), r = a.getLeftEyeVisibleTanAngles(), o = a.getLeftEyeNoLensTanAngles(), s = a.getLeftEyeVisibleScreenRect(o), c = 0, l = 0; l < 2; l++) {
								for (var u = 0; u < t; u++)
									for (var d = 0; d < e; d++, c++) {
										var M = d / (e - 1),
										g = u / (t - 1),
						...
						n.prototype.computeMeshIndices_ = function (e, t) {
							for (var a = new Uint16Array(2 * (e - 1) * (t - 1) * 6), n = e / 2, r = t / 2, i = 0, o = 0, s = 0; s < 2; s++)
								for (var c = 0; c < t; c++)
									for (var l = 0; l < e; l++, i++)
										0 != l && 0 != c && (l <= n == c <= r ? (a[o++] = i, a[o++] = i - e - 1, a[o++] = i - e, a[o++] = i - e - 1, a[o++] = i, a[o++] = i - 1) : (a[o++] = i - 1, a[o++] = i - e, a[o++] = i, a[o++] = i - e, a[o++] = i - 1, a[o++] = i - e - 1));
							return a
						},
				...
				4: [function (e, t, a) {
						function n(e) {
							...
							this.program = r.linkProgram(e, o, s, this.attribs),
						...
						var r = e("./util.js"),
						i = e("./deps/wglu-preserve-state.js"),
						...
						n.prototype.listen = function (e, t) {
							...
							this.listener = function (n) {
								...
								i = A * f;
								n.clientX > r - i && n.clientX < r + i && n.clientY > a.clientHeight - i ? e(n) : n.clientX < i && n.clientY < i && t(n)
							},
						...
						n.prototype.onResize = function () {
							...
							i(e, a, function (e) {
								function a(e, t) {
									...
									n = Math.cos(a),
									r = Math.sin(a);
									i.push(p * n * h + o, p * r * h + h),
									i.push(t * n * h + o, t * r * h + h)
								}
								function n(t, a) {
									i.push(v + t, e.drawingBufferHeight - v - a)
								}
								var i = [],
								o = e.drawingBufferWidth / 2,
								s = e.drawingBufferWidth / (screen.width * window.devicePixelRatio);
								r.isIOS() || (s *= window.devicePixelRatio);
								var D = m * s / 2,
								N = A * f * s,
								h = A * s / 2,
								v = (A * f - A) * s;
								i.push(o - D, N),
								i.push(o - D, e.drawingBufferHeight),
								i.push(o + D, N),
								i.push(o + D, e.drawingBufferHeight),
						...
						n.prototype.renderNoState = function () {
							...
							r.orthoMatrix(this.projMat, 0, e.drawingBufferWidth, 0, e.drawingBufferHeight, .1, 1024),
				...
				5: [function (e, t, a) {
						...
						var r = e("./cardboard-distorter.js"),
						i = e("./cardboard-ui.js"),
						o = e("./device-info.js"),
						s = e("./dpdb/dpdb.js"),
						...
						n.prototype.beginPresent_ = function () {
							...
							e && (this.layer_.predistorted ? WebVRConfig.CARDBOARD_UI_DISABLED || (e.canvas.width = M.getScreenWidth() * this.bufferScale_, e.canvas.height = M.getScreenHeight() * this.bufferScale_, this.cardboardUI_ = new i(e)) : (this.distorter_ = new r(e), this.distorter_.updateDeviceInfo(this.deviceInfo_), this.cardboardUI_ = this.distorter_.cardboardUI), this.cardboardUI_ && this.cardboardUI_.listen(function (e) {
				...
				6: [function (e, t, a) {
						function n(e, t, a) {
							if (!t)
								return void a(e);
							for (var n = [], r = null, i = 0; i < t.length; ++i) {
								var o = t[i];
								switch (o) {
								...
								case e.TEXTURE_BINDING_CUBE_MAP:
									...
									r || (r = e.getParameter(e.ACTIVE_TEXTURE)),
									e.activeTexture(s),
				...
				7: [function (e, t, a) {
						...
						r.prototype.updateDeviceParams = function (e) {
						...
						r.prototype.getDistortedFieldOfViewLeftEye = function () {
							...
							i = e.interLensDistance / 2,
							o = e.baselineLensDistance - t.bevelMeters,
							c = t.heightMeters - o,
							l = s.radToDeg * Math.atan(a.distort(r / n)),
							u = s.radToDeg * Math.atan(a.distort(i / n)),
						...
						r.prototype.getLeftEyeVisibleScreenRect = function (e) {
							...
							r = (a.widthMeters - t.interLensDistance) / 2,
							i = t.baselineLensDistance - a.bevelMeters,
							o = (e[0] * n + r) / a.widthMeters,
							s = (e[1] * n + i) / a.heightMeters,
							c = (e[2] * n + r) / a.widthMeters,
							l = (e[3] * n + i) / a.heightMeters;
							return {
								x: o,
								y: l,
								width: c - o,
				...
				8: [function (e, t, a) {
						...
						var i = (e("./base.js").VRDisplay, e("./base.js").HMDVRDevice),
						...
						t.exports.VRDisplayPositionSensorDevice = r
					}, {
						"./base.js": 2
					}
				],
				9: [function (e, t, a) {
						...
						n.prototype.solveLinear_ = function (e, t) {
							for (var a = e.length, n = 0; n < a - 1; ++n)
								for (var r = n + 1; r < a; ++r) {
									for (var i = e[n][r] / e[n][n], o = n + 1; o < a; ++o)
										e[o][r] -= i * e[o][n];
									t[r] -= i * t[n]
								}
				...
				11: [function (e, t, a) {
						function n(e, t) {
							if (this.dpdb = i, this.recalculateDeviceParams_(), e) {
						...
						n.prototype.matchRule_ = function (e, t, a, n) {
							...
							if (e.res) {
								...
								var r = e.res[0],
								i = e.res[1];
								if (Math.min(a, n) != Math.min(r, i) || Math.max(a, n) != Math.max(r, i))
									return !1
							}
							return !0
						},
				...
				14: [function (e, t, a) {
						...
						n.Vector3.prototype = {
							...
							applyQuaternion: function (e) {
								...
								u = s * n + r * a - i * t,
								d = -r * t - i * a - o * n;
								return this.x = c * s + d * -r + l * -o - u * -i,
								this.y = l * s + d * -i + u * -r - c * -o,
								this.z = u * s + d * -o + c * -i - l * -r,
								this
							},
							dot: function (e) {
						...
						n.Quaternion.prototype = {
							...
							multiplyQuaternions: function (e, t) {
								...
								c = t.z,
								l = t.w;
								return this.x = a * l + i * o + n * c - r * s,
								this.y = n * l + i * s + r * o - a * c,
								this.z = r * l + i * c + a * s - n * o,
								this.w = i * l - a * o - n * s - r * c,
								this
							},
							inverse: function () {
								return this.x *= -1,
							...
							slerp: function (e, t) {
								...
								r = this.z,
								i = this.w,
								o = i * e.w + a * e.x + n * e.y + r * e.z;
								if (o < 0 ? (this.w = -e.w, this.x = -e.x, this.y = -e.y, this.z = -e.z, o = -o) : this.copy(e), o >= 1)
									return this.w = i, this.x = a, this.y = n, this.z = r, this;
								var s = Math.acos(o),
								c = Math.sqrt(1 - o * o);
								if (Math.abs(c) < .001)
									return this.w = .5 * (i + this.w), this.x = .5 * (a + this.x), this.y = .5 * (n + this.y), this.z = .5 * (r + this.z), this;
								var l = Math.sin((1 - t) * s) / c,
								u = Math.sin(t * s) / c;
								return this.w = i * l + this.w * u,
								this.x = a * l + this.x * u,
								this.y = n * l + this.y * u,
								this.z = r * l + this.z * u,
								this
							...
							setFromUnitVectors: function () {
								...
								return function (r, i) {
									...
									t = r.dot(i) + 1,
									t < a ? (t = 0, Math.abs(r.x) > Math.abs(r.z) ? e.set(-r.y, r.x, 0) : e.set(0, -r.z, r.y)) : e.crossVectors(r, i),
									this.x = e.x,
									this.y = e.y,
									this.z = e.z,
									this.w = t,
				...
				15: [function (e, t, a) {
						function n() {
							...
							this.orientation_ = new i.Quaternion,
							this.rotateStart_ = new i.Vector2,
							this.rotateEnd_ = new i.Vector2,
							this.rotateDelta_ = new i.Vector2,
							this.isDragging_ = !1,
							this.orientationOut_ = new Float32Array(4)
						}
						var r = e("./base.js").VRDisplay,
						i = e("./math-util.js"),
						o = e("./util.js"),
						s = .15,
						c = 80,
				...
				16: [function (e, t, a) {
						function n() {
							...
							var i = document.createElement("div");
							i.style["float"] = "left",
							i.innerHTML = "No Cardboard viewer?";
						...
						n.prototype.show = function (e) {
							...
							a = t.style;
							r.isLandscapeMode() ? (a.width = "20%", a.marginLeft = "40%", a.marginTop = "3%") : (a.width = "50%", a.marginLeft = "25%", a.marginTop = "25%")
						},
						...
						n.prototype.update = function () {
							...
							!r.isLandscapeMode() && r.isMobile() ? this.show() : this.hide()
						},
				...
				17: [function (e, t, a) {
						function n(e) {
							...
							this.filterQ = new i.Quaternion(1, 0, 0, 1),
							this.previousFilterQ = new i.Quaternion,
							this.accelQ = new i.Quaternion,
							this.isOrientationInitialized = !1,
							this.estimatedGravity = new i.Vector3,
							this.measuredGravity = new i.Vector3,
							this.gyroIntegralQ = new i.Quaternion
						}
						var r = e("./sensor-sample.js"),
						i = e("../math-util.js"),
						o = e("../util.js"),
						s = !1;
						...
						n.prototype.run_ = function () {
							...
							var n = new i.Quaternion;
							n.setFromUnitVectors(this.estimatedGravity, this.measuredGravity),
							n.inverse(),
							s && console.log("Delta: %d deg, G_est: (%s, %s, %s), G_meas: (%s, %s, %s)", i.radToDeg * o.getQuaternionAngle(n), this.estimatedGravity.x.toFixed(1), this.estimatedGravity.y.toFixed(1), this.estimatedGravity.z.toFixed(1), this.measuredGravity.x.toFixed(1), this.measuredGravity.y.toFixed(1), this.measuredGravity.z.toFixed(1));
							var r = new i.Quaternion;
							r.copy(this.filterQ),
							r.multiply(n),
						...
						n.prototype.accelToQuaternion_ = function (e) {
							...
							t.normalize();
							var a = new i.Quaternion;
							return a.setFromUnitVectors(new i.Vector3(0, 0, (-1)), t),
							a.inverse(),
							a
						},
				...
				18: [function (e, t, a) {
						function n() {
							...
							this.filter = new r(WebVRConfig.K_FILTER),
							this.posePredictor = new i(WebVRConfig.PREDICTION_TIME_S),
						...
						var r = e("./complementary-filter.js"),
						i = e("./pose-predictor.js"),
						o = e("../touch-panner.js"),
						s = e("../math-util.js"),
						c = e("../util.js");
						...
						n.prototype.onDeviceMotionChange_ = function (e) {
							...
							var r = n - this.previousTimestampS;
							return r <= c.MIN_TIMESTEP || r > c.MAX_TIMESTEP ? (console.warn("Invalid timestamps detected. Time step between successive gyroscope sensor samples is very small or not monotonic"), void(this.previousTimestampS = n)) : (this.accelerometer.set(-t.x, -t.y, -t.z), this.gyroscope.set(a.alpha, a.beta, a.gamma), (this.isIOS || this.isFirefoxAndroid) && this.gyroscope.multiplyScalar(Math.PI / 180), this.filter.addAccelMeasurement(this.accelerometer, n), this.filter.addGyroMeasurement(this.gyroscope, n), void(this.previousTimestampS = n))
						},
				...
				19: [function (e, t, a) {
						function n(e) {
							...
							this.previousQ = new r.Quaternion,
							this.previousTimestampS = null,
							this.deltaQ = new r.Quaternion,
							this.outQ = new r.Quaternion
						}
						var r = e("../math-util.js"),
						i = !1;
						n.prototype.getPrediction = function (e, t, a) {
							...
							var o = t.length();
							if (o < 20 * r.degToRad)
								return i && console.log("Moving slowly, at %s deg/s: no prediction", (r.radToDeg * o).toFixed(1)), this.outQ.copy(e), this.previousQ.copy(e), this.outQ;
				...
				21: [function (e, t, a) {
						function n() {
							...
							this.theta = 0,
							this.orientation = new r.Quaternion
						}
						var r = e("./math-util.js"),
						i = e("./util.js"),
						o = .5;
				...
				22: [function (e, t, a) {
						...
						r.clamp = function (e, t, a) {
							return Math.min(Math.max(t, e), a)
						},
						r.lerp = function (e, t, a) {
							return e + (t - e) * a
						},
						r.isIOS = function () {
						...
						r.linkProgram = function (e, t, a, n) {
						...
						r.getProgramUniforms = function (e, t) {
							for (var a = {}, n = e.getProgramParameter(t, e.ACTIVE_UNIFORMS), r = "", i = 0; i < n; i++) {
								var o = e.getActiveUniform(t, i);
								r = o.name.replace("[0]", ""),
								a[r] = e.getUniformLocation(t, r)
							}
							return a
						},
						r.orthoMatrix = function (e, t, a, n, r, i, o) {
							var s = 1 / (t - a),
							c = 1 / (n - r),
							l = 1 / (i - o);
							return e[0] = -2 * s,
				...
				23: [function (e, t, a) {
						function n() {
							...
							this.dialog = this.createDialog_(i.Viewers),
							this.root = null
						}
						var r = e("./emitter.js"),
						i = (e("./util.js"), e("./device-info.js")),
						o = "CardboardV1",
						...
						n.prototype.getCurrentViewer = function () {
							return i.Viewers[this.selectedKey]
						},
						...
						n.prototype.onSave_ = function () {
							if (this.selectedKey = this.getSelectedKey_(), !this.selectedKey || !i.Viewers[this.selectedKey])
								return void console.error("ViewerSelector.onSave_: this should never happen!");
							this.emit("change", i.Viewers[this.selectedKey]);
							try {
						...
						n.prototype.createDialog_ = function (e) {
							...
							for (var o in e)
								i.appendChild(this.createChoice_(o, e[o].label));
							return i.appendChild(this.createButton_("Save", this.onSave_.bind(this))),
							t.appendChild(a),
							t.appendChild(i),
							t
						},
						...
						n.prototype.createChoice_ = function (e, t) {
							...
							return r.style.marginLeft = "4px",
							r.setAttribute("for", e),
							r.innerHTML = t,
							a.appendChild(n),
							a.appendChild(r),
							a
				...
				24: [function (e, t, a) {
						...
						function i() {
							...
							return e.match(/iPhone/i) || e.match(/iPod/i) ? r : n
						}
						var o = e("./util.js");
						t.exports = i()
					}, {
				...
				25: [function (e, t, a) {
						...
						var r = e("./cardboard-vr-display.js"),
						i = e("./mouse-keyboard-vr-display.js"),
						...
						n.prototype.populateDevices = function () {
							if (!this.devicesPopulated) {
								var e = null;
								this.isCardboardCompatible() && (e = new r, this.displays.push(e), WebVRConfig.ENABLE_DEPRECATED_API && (this.devices.push(new l(e)), this.devices.push(new u(e)))),
								this.isMobile() || WebVRConfig.MOUSE_KEYBOARD_CONTROLS_DISABLED || (e = new i, this.displays.push(e), WebVRConfig.ENABLE_DEPRECATED_API && (this.devices.push(new l(e)), this.devices.push(new u(e)))),
